...
import { commandMenuActionsStacked } from "../../../src/application.ts";

import { componentMeta } from "../story.ts";
import { commandMenuActionStories } from "./command-menu-actions.story.ts";

export default {
  ...componentMeta("command-menu-actions-stacked"),
  title: "Untitled UI/Application/Command Menu Actions Stacked",
};

const stories = commandMenuActionStories(commandMenuActionsStacked, "command-menu-actions-stacked");
