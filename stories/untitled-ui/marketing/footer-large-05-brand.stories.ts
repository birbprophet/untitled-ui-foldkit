...
import { footerLarge05Brand } from "../../../src/marketing/footer-large-05-brand.ts";
...
const HomePressed = m("FooterLarge05BrandHomePressed");
const LinkPressed = m("FooterLarge05BrandLinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge05BrandSocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge05BrandLinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge05BrandSocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge05Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge05Brand(
...
export default {
  ...componentMeta("footer-large-05-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 05 Brand",
};
