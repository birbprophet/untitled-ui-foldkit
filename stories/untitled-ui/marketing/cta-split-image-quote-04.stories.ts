...
import { ctaSplitImageQuote04 } from "../../../../../packages/ui/src/marketing/cta-split-image-quote-04.ts";
...
const Primary = m("CtaSplitImageQuote04Primary");
const Secondary = m("CtaSplitImageQuote04Secondary");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof ctaSplitImageQuote04<Message>>[1]) =>
    h.div([h.Class("-m-8")], [
      ctaSplitImageQuote04({ ...model, onPrimary: Primary(), onSecondary: Secondary() }, h),
    ]),
} as const;
...
export default { ...componentMeta("cta-split-image-quote-04"), parameters: { layout: "fullscreen" }, title: "Untitled UI/Marketing/Cta/Cta Split Image Quote 04" };
