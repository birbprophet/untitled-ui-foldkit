...
import { ctaCardVerticalBrand } from "../../../../../packages/ui/src/marketing/cta-card-vertical-brand.ts";
...
const Primary = m("CtaCardVerticalBrandPrimary");
const Secondary = m("CtaCardVerticalBrandSecondary");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof ctaCardVerticalBrand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
...
export default {
  ...componentMeta("cta-card-vertical-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Cta/Cta Card Vertical Brand",
};
