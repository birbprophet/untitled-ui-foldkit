...
import { newsletterScreenMockup03 } from "../../../../../packages/ui/src/marketing/newsletter-screen-mockup-03.ts";
...
const Action = m("NewsletterScreenMockup03Action", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof newsletterScreenMockup03<Message>>[1]) =>
    h.div([h.Class("-m-8")], [newsletterScreenMockup03({ ...model, description: model.description, heading: model.heading, onAction: Action({ id: "action" }) }, h)]),
} as const;
...
export default {
  ...componentMeta("newsletter-screen-mockup-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Newsletter Cta/Newsletter Screen Mockup 03",
};
