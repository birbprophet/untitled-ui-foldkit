...
import { pricingSectionSimpleCards04 } from "../../../../../packages/ui/src/marketing/pricing-section-simple-cards-04.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof pricingSectionSimpleCards04>[1]) =>
    h.div([h.Class("-m-8")], [pricingSectionSimpleCards04({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("pricing-section-simple-cards-04"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Pricing Sections/Pricing Section Simple Cards 04",
};
