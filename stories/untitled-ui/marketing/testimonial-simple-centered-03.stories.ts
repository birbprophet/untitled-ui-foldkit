...
import { testimonialSimpleCentered03 } from "../../../../../packages/ui/src/marketing/testimonial-simple-centered-03.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialSimpleCentered03>[1]) =>
    h.div([h.Class("-m-8")], [testimonialSimpleCentered03({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-simple-centered-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Simple Centered 03",
};
