...
import { ctaSplitImageQuote02 } from "../../../../../packages/ui/src/marketing/cta-split-image-quote-02.ts";
...
const Primary = m("CtaSplitImageQuote02Primary");
const Secondary = m("CtaSplitImageQuote02Secondary");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof ctaSplitImageQuote02<Message>>[1]) =>
    h.div([h.Class("-m-8")], [
      ctaSplitImageQuote02({ ...model, onPrimary: Primary(), onSecondary: Secondary() }, h),
    ]),
} as const;
...
export default { ...componentMeta("cta-split-image-quote-02"), parameters: { layout: "fullscreen" }, title: "Untitled UI/Marketing/Cta/Cta Split Image Quote 02" };
