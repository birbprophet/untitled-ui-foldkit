...
import { menu4ColWithFooter } from "../../../../../packages/ui/src/marketing/menu-4-col-with-footer.ts";
...
const Action = m("Menu4ColWithFooterAction", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof menu4ColWithFooter<Message>>[1]) =>
    h.div([h.Class("-m-8")], [menu4ColWithFooter({ ...model, description: model.description, heading: model.heading, onAction: Action({ id: "action" }) }, h)]),
} as const;
