...
import { ctaSimpleLogos01 } from "../../../../../packages/ui/src/marketing/cta-simple-logos-01.ts";
...
const Primary = m("CtaSimpleLogos01Primary");
const Secondary = m("CtaSimpleLogos01Secondary");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof ctaSimpleLogos01<Message>>[1]) =>
    h.div([h.Class("-m-8")], [
      ctaSimpleLogos01({ ...model, onPrimary: Primary(), onSecondary: Secondary() }, h),
    ]),
} as const;
...
export default { ...componentMeta("cta-simple-logos-01"), parameters: { layout: "fullscreen" }, title: "Untitled UI/Marketing/Cta/Cta Simple Logos 01" };
