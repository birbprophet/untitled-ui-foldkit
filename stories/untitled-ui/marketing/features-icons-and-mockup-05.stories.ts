...
import { featuresIconsAndMockup05 } from "../../../../../packages/ui/src/marketing/features-icons-and-mockup-05.ts";
...
const ItemPressed = m("FeaturesIconsAndMockup05ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresIconsAndMockup05<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresIconsAndMockup05({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-icons-and-mockup-05"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Icons And Mockup 05",
};
