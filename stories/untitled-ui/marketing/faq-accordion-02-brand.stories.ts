...
import {
  faqAccordion02Brand,
  faqAccordion02BrandDefaultItems,
} from "../../../../../packages/ui/src/marketing/faq-accordion-02-brand.ts";
...
const Cta = m("FaqAccordion02BrandCta");
const Toggle = m("FaqAccordion02BrandToggle", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FaqAccordion02BrandToggle") {
  ...
  view: (model: Model, h: Parameters<typeof faqAccordion02Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        faqAccordion02Brand(
...
const args = {
  ...
  items: [...faqAccordion02BrandDefaultItems],
} as const;

export default {
  ...componentMeta("faq-accordion-02-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Faq/Faq Accordion 02 Brand",
};
