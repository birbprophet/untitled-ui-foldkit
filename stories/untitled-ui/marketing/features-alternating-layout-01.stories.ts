...
import { featuresAlternatingLayout01 } from "../../../../../packages/ui/src/marketing/features-alternating-layout-01.ts";
...
const ItemPressed = m("FeaturesAlternatingLayout01ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresAlternatingLayout01<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresAlternatingLayout01({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-alternating-layout-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Alternating Layout 01",
};
