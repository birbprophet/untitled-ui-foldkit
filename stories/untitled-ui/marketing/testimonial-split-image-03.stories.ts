...
import { testimonialSplitImage03 } from "../../../../../packages/ui/src/marketing/testimonial-split-image-03.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialSplitImage03>[1]) =>
    h.div([h.Class("-m-8")], [testimonialSplitImage03({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-split-image-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Split Image 03",
};
