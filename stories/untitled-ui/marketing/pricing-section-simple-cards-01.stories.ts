...
import { pricingSectionSimpleCards01 } from "../../../../../packages/ui/src/marketing/pricing-section-simple-cards-01.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof pricingSectionSimpleCards01>[1]) =>
    h.div([h.Class("-m-8")], [pricingSectionSimpleCards01({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("pricing-section-simple-cards-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Pricing Sections/Pricing Section Simple Cards 01",
};
