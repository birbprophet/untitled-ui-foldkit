...
import { footerLarge06Brand } from "../../../src/marketing/footer-large-06-brand.ts";
...
const HomePressed = m("FooterLarge06BrandHomePressed");
const LinkPressed = m("FooterLarge06BrandLinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge06BrandSocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge06BrandLinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge06BrandSocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge06Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge06Brand(
...
export default {
  ...componentMeta("footer-large-06-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 06 Brand",
};
