...
import { footerLarge03 } from "../../../src/marketing/footer-large-03.ts";
...
const HomePressed = m("FooterLarge03HomePressed");
const LinkPressed = m("FooterLarge03LinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge03SocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge03LinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge03SocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge03<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge03(
...
export default {
  ...componentMeta("footer-large-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 03",
};
