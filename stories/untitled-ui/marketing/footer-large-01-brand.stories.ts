...
const HomePressed = m("FooterLarge01BrandHomePressed");
const LinkPressed = m("FooterLarge01BrandLinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge01BrandSocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge01BrandLinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge01BrandSocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge01Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge01Brand(
...
export default {
  ...componentMeta("footer-large-01-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 01 Brand",
};
