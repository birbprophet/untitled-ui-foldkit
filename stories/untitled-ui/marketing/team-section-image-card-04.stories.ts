...
import { teamSectionImageCard04 } from "../../../../../packages/ui/src/marketing/team-section-image-card-04.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof teamSectionImageCard04>[1]) =>
    h.div([h.Class("-m-8")], [teamSectionImageCard04({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
