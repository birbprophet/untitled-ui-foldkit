...
import { footerLarge05 } from "../../../src/marketing/footer-large-05.ts";
...
const HomePressed = m("FooterLarge05HomePressed");
const LinkPressed = m("FooterLarge05LinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge05SocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge05LinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge05SocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge05<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge05(
...
export default {
  ...componentMeta("footer-large-05"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 05",
};
