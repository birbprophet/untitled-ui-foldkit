...
import { pricingSimpleDualCheckItem } from "../../../../../packages/ui/src/marketing/pricing-simple-dual-check-item.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof pricingSimpleDualCheckItem>[1]) =>
    h.div([h.Class("-m-8")], [pricingSimpleDualCheckItem({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("pricing-simple-dual-check-item"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Pricing Sections/Pricing Simple Dual Check Item",
};
