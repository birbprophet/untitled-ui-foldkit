...
import { pricingSectionSimpleCards02 } from "../../../../../packages/ui/src/marketing/pricing-section-simple-cards-02.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof pricingSectionSimpleCards02>[1]) =>
    h.div([h.Class("-m-8")], [pricingSectionSimpleCards02({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("pricing-section-simple-cards-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Pricing Sections/Pricing Section Simple Cards 02",
};
