...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof headerSpaceBetween<Message>>[1]) =>
    h.div([h.Class("-m-8")], [headerSpaceBetween({ ...model }, h)]),
} as const;
...
export default {
  ...componentMeta("header-space-between"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Header Space Between",
};
