...
import { featuresSimpleIcons02 } from "../../../../../packages/ui/src/marketing/features-simple-icons-02.ts";
...
const ItemPressed = m("FeaturesSimpleIcons02ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresSimpleIcons02<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresSimpleIcons02({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-simple-icons-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Simple Icons 02",
};
