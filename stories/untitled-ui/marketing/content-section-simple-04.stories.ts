...
import { contentSectionSimple04 } from "../../../../../packages/ui/src/marketing/content-section-simple-04.ts";
...
const specimen = (props: Args, h: Parameters<typeof contentSectionSimple04>[1]) =>
  h.div([h.Class("-m-8")], [contentSectionSimple04(props, h)]);

export default {
  ...componentMeta("content-section-simple-04"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Content/Content Section Simple 04",
};
...
export const Dark = {
  ...staticStory(Args, (props, h) =>
    h.div([h.Class("-m-8 min-h-screen bg-bg-primary"), h.DataAttribute("theme", "dark")], [contentSectionSimple04(props, h)]),
  ),
  args,
};
