...
import { ctaIphoneMockup01 } from "../../../../../packages/ui/src/marketing/cta-iphone-mockup-01.ts";
...
const Action = m("CtaIphoneMockup01Action");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof ctaIphoneMockup01<Message>>[1]) =>
    h.div([h.Class("-m-8")], [ctaIphoneMockup01({ ...model, onAction: Action() }, h)]),
} as const;
...
export default {
  ...componentMeta("cta-iphone-mockup-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Cta/Cta Iphone Mockup 01",
};
