...
import { careersSimple04 } from "../../../../../packages/ui/src/marketing/careers-simple-04.ts";
...
const Selected = m("CareersSimple04JobSelected", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof careersSimple04<Message>>[1]) =>
    h.div([h.Class("-m-8")], [careersSimple04({ ...model, onJob: (id) => Selected({ id }) }, h)]),
} as const;
const jobs = [
  {
    badgeColor: "blue",
...
export default {
  ...componentMeta("careers-simple-04"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Careers/Careers Simple 04",
};
