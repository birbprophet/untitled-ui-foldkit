...
import { featuresIconCards01 } from "../../../../../packages/ui/src/marketing/features-icon-cards-01.ts";
...
const ItemPressed = m("FeaturesIconCards01ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresIconCards01<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresIconCards01({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-icon-cards-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Icon Cards 01",
};
