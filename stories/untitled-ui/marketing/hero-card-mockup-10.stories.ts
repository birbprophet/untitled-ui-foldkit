...
import { heroCardMockup10 } from "../../../../../packages/ui/src/marketing/hero-card-mockup-10.ts";
...
const Primary = m("HeroCardMockup10Primary");
const Secondary = m("HeroCardMockup10Secondary");
const Navigated = m("HeroCardMockup10Navigated", { href: S.String });
const MobileOpened = m("HeroCardMockup10MobileOpened");
const MobileClosed = m("HeroCardMockup10MobileClosed");
const AccountPressed = m("HeroCardMockup10AccountPressed");
const SearchChanged = m("HeroCardMockup10SearchChanged", { value: S.String });
type Message =
  | typeof Primary.Type
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "HeroCardMockup10MobileOpened") {
      return { ...model, isMobileOpen: true };
    }
    if (message._tag === "HeroCardMockup10MobileClosed") {
      return { ...model, isMobileOpen: false };
    }
    if (message._tag === "HeroCardMockup10SearchChanged") {
      return { ...model, searchValue: message.value };
    }
    return model;
  },
  view: (model: Model, h: Parameters<typeof heroCardMockup10<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        heroCardMockup10(
...
export default {
  ...componentMeta("hero-card-mockup-10"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Hero Card Mockup 10",
};
