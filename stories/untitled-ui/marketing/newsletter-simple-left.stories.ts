...
import { newsletterSimpleLeft } from "../../../../../packages/ui/src/marketing/newsletter-simple-left.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof newsletterSimpleLeft>[1]) =>
    h.div([h.Class("-m-8")], [newsletterSimpleLeft({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("newsletter-simple-left"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Newsletter Cta/Newsletter Simple Left",
};
