...
import { heroCardMockup03 } from "../../../src/marketing/hero-card-mockup-03.ts";
...
const Primary = m("HeroCardMockup03Primary");
const Secondary = m("HeroCardMockup03Secondary");
const Navigated = m("HeroCardMockup03Navigated", { href: S.String });
const MobileOpened = m("HeroCardMockup03MobileOpened");
const MobileClosed = m("HeroCardMockup03MobileClosed");
const AccountPressed = m("HeroCardMockup03AccountPressed");
const SearchChanged = m("HeroCardMockup03SearchChanged", { value: S.String });
const Badge = m("HeroCardMockup03Badge");
type Message =
  | typeof Primary.Type
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "HeroCardMockup03MobileOpened") {
      return { ...model, isMobileOpen: true };
    }
    if (message._tag === "HeroCardMockup03MobileClosed") {
      return { ...model, isMobileOpen: false };
    }
    if (message._tag === "HeroCardMockup03SearchChanged") {
      return { ...model, searchValue: message.value };
    }
    return model;
  },
  view: (model: Model, h: Parameters<typeof heroCardMockup03<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        heroCardMockup03(
...
export default {
  ...componentMeta("hero-card-mockup-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Hero Card Mockup 03",
};
