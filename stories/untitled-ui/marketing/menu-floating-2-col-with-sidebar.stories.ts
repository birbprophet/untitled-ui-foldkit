...
import { menuFloating2ColWithSidebar } from "../../../../../packages/ui/src/marketing/menu-floating-2-col-with-sidebar.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof menuFloating2ColWithSidebar>[1]) =>
    h.div([h.Class("-m-8")], [menuFloating2ColWithSidebar({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
