...
import { metricsSplitImage01 } from "../../../../../packages/ui/src/marketing/metrics-split-image-01.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof metricsSplitImage01>[1]) =>
    h.div([h.Class("-m-8")], [metricsSplitImage01({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("metrics-split-image-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Metrics/Metrics Split Image 01",
};
