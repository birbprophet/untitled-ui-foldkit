...
import { metricsSplitImage02Brand } from "../../../../../packages/ui/src/marketing/metrics-split-image-02-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof metricsSplitImage02Brand>[1]) =>
    h.div([h.Class("-m-8")], [metricsSplitImage02Brand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("metrics-split-image-02-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Metrics/Metrics Split Image 02 Brand",
};
