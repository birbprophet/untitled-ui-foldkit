...
import {
  faqSimple01Brand,
  faqSimple01BrandDefaultItems,
} from "../../../../../packages/ui/src/marketing/faq-simple-01-brand.ts";
...
const Cta = m("FaqSimple01BrandCta");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof faqSimple01Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        faqSimple01Brand(
...
const args = {
  ...
  items: [...faqSimple01BrandDefaultItems],
} as const;

export default {
  ...componentMeta("faq-simple-01-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Faq/Faq Simple 01 Brand",
};
