...
import { teamSectionSimple03 } from "../../../../../packages/ui/src/marketing/team-section-simple-03.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof teamSectionSimple03>[1]) =>
    h.div([h.Class("-m-8")], [teamSectionSimple03({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
