...
import { teamSectionImageCard02 } from "../../../../../packages/ui/src/marketing/team-section-image-card-02.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof teamSectionImageCard02>[1]) =>
    h.div([h.Class("-m-8")], [teamSectionImageCard02({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
