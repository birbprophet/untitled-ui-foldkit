...
const HomePressed = m("FooterLarge11HomePressed");
const LinkPressed = m("FooterLarge11LinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge11SocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge11HomePressed") {
      return { ...model, homeHref: "#home-opened" };
    }
    if (message._tag === "FooterLarge11LinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge11SocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge11<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge11(
...
export default {
  ...componentMeta("footer-large-11"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 11",
};
