...
import { featuresIntegrationsIcons03 } from "../../../../../packages/ui/src/marketing/features-integrations-icons-03.ts";
...
const ItemPressed = m("FeaturesIntegrationsIcons03ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresIntegrationsIcons03<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresIntegrationsIcons03({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-integrations-icons-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Integrations Icons 03",
};
