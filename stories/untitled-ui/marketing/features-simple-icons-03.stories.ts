...
import { featuresSimpleIcons03 } from "../../../../../packages/ui/src/marketing/features-simple-icons-03.ts";
...
const ItemPressed = m("FeaturesSimpleIcons03ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresSimpleIcons03<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresSimpleIcons03({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-simple-icons-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Simple Icons 03",
};
