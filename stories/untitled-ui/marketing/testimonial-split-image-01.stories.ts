...
import { testimonialSplitImage01 } from "../../../../../packages/ui/src/marketing/testimonial-split-image-01.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialSplitImage01>[1]) =>
    h.div([h.Class("-m-8")], [testimonialSplitImage01({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-split-image-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Split Image 01",
};
