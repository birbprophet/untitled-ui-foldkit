...
import { heroScreenMockup01 } from "../../../../../packages/ui/src/marketing/hero-screen-mockup-01.ts";
...
const Primary = m("HeroScreenMockup01Primary");
const Secondary = m("HeroScreenMockup01Secondary");
const Navigated = m("HeroScreenMockup01Navigated", { href: S.String });
const MobileOpened = m("HeroScreenMockup01MobileOpened");
const MobileClosed = m("HeroScreenMockup01MobileClosed");
const AccountPressed = m("HeroScreenMockup01AccountPressed");
const SearchChanged = m("HeroScreenMockup01SearchChanged", { value: S.String });
type Message =
  | typeof Primary.Type
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "HeroScreenMockup01MobileOpened") {
      return { ...model, isMobileOpen: true };
    }
    if (message._tag === "HeroScreenMockup01MobileClosed") {
      return { ...model, isMobileOpen: false };
    }
    if (message._tag === "HeroScreenMockup01SearchChanged") {
      return { ...model, searchValue: message.value };
    }
    return model;
  },
  view: (model: Model, h: Parameters<typeof heroScreenMockup01<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        heroScreenMockup01(
...
export default {
  ...componentMeta("hero-screen-mockup-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Hero Screen Mockup 01",
};
