...
import { featuresTabsMockup10 } from "../../../../../packages/ui/src/marketing/features-tabs-mockup-10.ts";
...
const TabSelected = m("FeaturesTabsMockup10TabSelected", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresTabsMockup10<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresTabsMockup10({ ...model, onSelect: (id) => TabSelected({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-tabs-mockup-10"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Tabs Mockup 10",
};
