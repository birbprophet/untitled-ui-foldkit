...
const Cta = m("FaqSimple04BrandCta");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof faqSimple04Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        faqSimple04Brand(
...
const args = {
  ...
  items: [...faqSimple04BrandDefaultItems],
} as const;

export default {
  ...componentMeta("faq-simple-04-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Faq/Faq Simple 04 Brand",
};
