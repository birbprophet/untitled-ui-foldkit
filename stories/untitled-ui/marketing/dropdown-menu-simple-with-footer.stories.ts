...
import { dropdownMenuSimpleWithFooter } from "../../../../../packages/ui/src/marketing/dropdown-menu-simple-with-footer.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof dropdownMenuSimpleWithFooter<Message>>[1]) =>
    h.div([h.Class("-m-8")], [dropdownMenuSimpleWithFooter({ ...model, description: model.description, heading: model.heading, onAction: Action({ id: "action" }) }, h)]),
} as const;
