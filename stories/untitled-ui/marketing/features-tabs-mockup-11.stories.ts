...
import { featuresTabsMockup11 } from "../../../../../packages/ui/src/marketing/features-tabs-mockup-11.ts";
...
const TabSelected = m("FeaturesTabsMockup11TabSelected", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresTabsMockup11<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresTabsMockup11({ ...model, onSelect: (id) => TabSelected({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-tabs-mockup-11"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Tabs Mockup 11",
};
