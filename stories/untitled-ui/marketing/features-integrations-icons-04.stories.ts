...
import { featuresIntegrationsIcons04 } from "../../../../../packages/ui/src/marketing/features-integrations-icons-04.ts";
...
const ItemPressed = m("FeaturesIntegrationsIcons04ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresIntegrationsIcons04<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresIntegrationsIcons04({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-integrations-icons-04"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Integrations Icons 04",
};
