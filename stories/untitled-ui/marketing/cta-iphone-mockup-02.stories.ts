...
import { ctaIphoneMockup02 } from "../../../../../packages/ui/src/marketing/cta-iphone-mockup-02.ts";
...
const Action = m("CtaIphoneMockup02Action");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof ctaIphoneMockup02<Message>>[1]) =>
    h.div([h.Class("-m-8")], [ctaIphoneMockup02({ ...model, onAction: Action() }, h)]),
} as const;
...
export default {
  ...componentMeta("cta-iphone-mockup-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Cta/Cta Iphone Mockup 02",
};
