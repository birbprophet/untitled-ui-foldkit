...
import { featuresTabsMockup07 } from "../../../../../packages/ui/src/marketing/features-tabs-mockup-07.ts";
...
const TabSelected = m("FeaturesTabsMockup07TabSelected", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresTabsMockup07<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresTabsMockup07({ ...model, onSelect: (id) => TabSelected({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-tabs-mockup-07"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Tabs Mockup 07",
};
