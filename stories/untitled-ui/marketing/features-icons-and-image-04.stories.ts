...
import { featuresIconsAndImage04 } from "../../../../../packages/ui/src/marketing/features-icons-and-image-04.ts";
...
const ItemPressed = m("FeaturesIconsAndImage04ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresIconsAndImage04<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresIconsAndImage04({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-icons-and-image-04"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Icons And Image 04",
};
