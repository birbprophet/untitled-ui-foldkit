...
import { featuresSimpleIcons01Brand } from "../../../../../packages/ui/src/marketing/features-simple-icons-01-brand.ts";
...
const ItemPressed = m("FeaturesSimpleIcons01BrandItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresSimpleIcons01Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresSimpleIcons01Brand({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-simple-icons-01-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Simple Icons 01 Brand",
};
