...
const HomePressed = m("FooterLarge07HomePressed");
const LinkPressed = m("FooterLarge07LinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge07SocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge07LinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge07SocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge07<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge07(
...
export default {
  ...componentMeta("footer-large-07"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 07",
};
