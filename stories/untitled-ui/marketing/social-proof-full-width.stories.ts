...
import { socialProofFullWidth } from "../../../../../packages/ui/src/marketing/social-proof-full-width.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof socialProofFullWidth>[1]) =>
    h.div([h.Class("-m-8")], [socialProofFullWidth({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("social-proof-full-width"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Social Proof/Social Proof Full Width",
};
