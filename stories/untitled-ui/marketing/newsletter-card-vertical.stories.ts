...
import { newsletterCardVertical } from "../../../../../packages/ui/src/marketing/newsletter-card-vertical.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof newsletterCardVertical>[1]) =>
    h.div([h.Class("-m-8")], [newsletterCardVertical({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("newsletter-card-vertical"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Newsletter Cta/Newsletter Card Vertical",
};
