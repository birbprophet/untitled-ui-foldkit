...
import { heroCardMockup08 } from "../../../../../packages/ui/src/marketing/hero-card-mockup-08.ts";
...
const Primary = m("HeroCardMockup08Primary");
const EmailInput = m("HeroCardMockup08EmailInput", { email: S.String });
const Submit = m("HeroCardMockup08Submit");
const Secondary = m("HeroCardMockup08Secondary");
const Navigated = m("HeroCardMockup08Navigated", { href: S.String });
const MobileOpened = m("HeroCardMockup08MobileOpened");
const MobileClosed = m("HeroCardMockup08MobileClosed");
const AccountPressed = m("HeroCardMockup08AccountPressed");
const SearchChanged = m("HeroCardMockup08SearchChanged", { value: S.String });
type Message =
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "HeroCardMockup08MobileOpened") {
      return { ...model, isMobileOpen: true };
    }
    if (message._tag === "HeroCardMockup08MobileClosed") {
      return { ...model, isMobileOpen: false };
    }
    if (message._tag === "HeroCardMockup08SearchChanged") {
      return { ...model, searchValue: message.value };
    }
    return model;
  },
  view: (model: Model, h: Parameters<typeof heroCardMockup08<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        heroCardMockup08(
...
export default {
  ...componentMeta("hero-card-mockup-08"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Hero Card Mockup 08",
};
