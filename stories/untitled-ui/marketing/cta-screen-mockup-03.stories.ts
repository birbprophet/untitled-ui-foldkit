...
import { ctaScreenMockup03 } from "../../../../../packages/ui/src/marketing/cta-screen-mockup-03.ts";
...
const Primary = m("CtaScreenMockup03Primary");
const Secondary = m("CtaScreenMockup03Secondary");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof ctaScreenMockup03<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        ctaScreenMockup03(
...
export default {
  ...componentMeta("cta-screen-mockup-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Cta/Cta Screen Mockup 03",
};
