...
import { testimonialCardSplitImageBrand } from "../../../../../packages/ui/src/marketing/testimonial-card-split-image-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialCardSplitImageBrand>[1]) =>
    h.div([h.Class("-m-8")], [testimonialCardSplitImageBrand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-card-split-image-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Card Split Image Brand",
};
