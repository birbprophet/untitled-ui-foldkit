...
import { featuresLargeScreenMockup01 } from "../../../../../packages/ui/src/marketing/features-large-screen-mockup-01.ts";
...
const ItemPressed = m("FeaturesLargeScreenMockup01ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresLargeScreenMockup01<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresLargeScreenMockup01({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-large-screen-mockup-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Large Screen Mockup 01",
};
