...
import { testimonialSocialCards03 } from "../../../../../packages/ui/src/marketing/testimonial-social-cards-03.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialSocialCards03>[1]) =>
    h.div([h.Class("-m-8")], [testimonialSocialCards03({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-social-cards-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Social Cards 03",
};
