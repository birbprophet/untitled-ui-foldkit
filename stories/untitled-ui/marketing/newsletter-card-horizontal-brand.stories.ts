...
import { newsletterCardHorizontalBrand } from "../../../../../packages/ui/src/marketing/newsletter-card-horizontal-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof newsletterCardHorizontalBrand>[1]) =>
    h.div([h.Class("-m-8")], [newsletterCardHorizontalBrand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
