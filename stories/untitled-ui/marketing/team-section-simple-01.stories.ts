...
import { teamSectionSimple01 } from "../../../../../packages/ui/src/marketing/team-section-simple-01.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof teamSectionSimple01>[1]) =>
    h.div([h.Class("-m-8")], [teamSectionSimple01({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
