...
import { headerCenteredButtons } from "../../../../../packages/ui/src/marketing/header-centered-buttons.ts";
...
const Primary = m("HeaderCenteredButtonsPrimary");
const Secondary = m("HeaderCenteredButtonsSecondary");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof headerCenteredButtons<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [headerCenteredButtons({ ...model, onPrimary: Primary(), onSecondary: Secondary() }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("header-centered-buttons"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Header Centered Buttons",
};
