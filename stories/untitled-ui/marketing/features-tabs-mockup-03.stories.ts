...
import { featuresTabsMockup03 } from "../../../../../packages/ui/src/marketing/features-tabs-mockup-03.ts";
...
const TabSelected = m("FeaturesTabsMockup03TabSelected", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresTabsMockup03<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresTabsMockup03({ ...model, onSelect: (id) => TabSelected({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-tabs-mockup-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Tabs Mockup 03",
};
