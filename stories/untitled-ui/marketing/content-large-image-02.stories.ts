...
import {
  contentLargeImage02,
  contentLargeImage02Defaults,
} from "../../../src/marketing/content-large-image-02.ts";
...
export default {
  ...componentMeta("content-large-image-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Content/Content Large Image 02",
};
