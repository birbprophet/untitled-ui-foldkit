...
import { testimonialSimpleCentered02 } from "../../../../../packages/ui/src/marketing/testimonial-simple-centered-02.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialSimpleCentered02>[1]) =>
    h.div([h.Class("-m-8")], [testimonialSimpleCentered02({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-simple-centered-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Simple Centered 02",
};
