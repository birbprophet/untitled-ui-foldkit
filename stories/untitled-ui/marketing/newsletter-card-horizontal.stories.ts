...
import { newsletterCardHorizontal } from "../../../../../packages/ui/src/marketing/newsletter-card-horizontal.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof newsletterCardHorizontal>[1]) =>
    h.div([h.Class("-m-8")], [newsletterCardHorizontal({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("newsletter-card-horizontal"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Newsletter Cta/Newsletter Card Horizontal",
};
