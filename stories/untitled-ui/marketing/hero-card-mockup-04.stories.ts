...
import { heroCardMockup04 } from "../../../../../packages/ui/src/marketing/hero-card-mockup-04.ts";
...
const Primary = m("HeroCardMockup04Primary");
const Secondary = m("HeroCardMockup04Secondary");
const Navigated = m("HeroCardMockup04Navigated", { href: S.String });
const MobileOpened = m("HeroCardMockup04MobileOpened");
const MobileClosed = m("HeroCardMockup04MobileClosed");
const AccountPressed = m("HeroCardMockup04AccountPressed");
const SearchChanged = m("HeroCardMockup04SearchChanged", { value: S.String });
type Message =
  | typeof Primary.Type
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "HeroCardMockup04MobileOpened") {
      return { ...model, isMobileOpen: true };
    }
    if (message._tag === "HeroCardMockup04MobileClosed") {
      return { ...model, isMobileOpen: false };
    }
    if (message._tag === "HeroCardMockup04SearchChanged") {
      return { ...model, searchValue: message.value };
    }
    return model;
  },
  view: (model: Model, h: Parameters<typeof heroCardMockup04<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        heroCardMockup04(
...
export default {
  ...componentMeta("hero-card-mockup-04"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Hero Card Mockup 04",
};
