...
import { testimonialSimpleCentered01Brand } from "../../../../../packages/ui/src/marketing/testimonial-simple-centered-01-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialSimpleCentered01Brand>[1]) =>
    h.div([h.Class("-m-8")], [testimonialSimpleCentered01Brand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-simple-centered-01-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Simple Centered 01 Brand",
};
