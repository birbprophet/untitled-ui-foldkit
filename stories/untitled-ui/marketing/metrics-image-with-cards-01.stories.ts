...
import { metricsImageWithCards01 } from "../../../../../packages/ui/src/marketing/metrics-image-with-cards-01.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof metricsImageWithCards01>[1]) =>
    h.div([h.Class("-m-8")], [metricsImageWithCards01({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
