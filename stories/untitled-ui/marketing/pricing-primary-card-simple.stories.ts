...
import { pricingPrimaryCardSimple } from "../../../../../packages/ui/src/marketing/pricing-primary-card-simple.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof pricingPrimaryCardSimple>[1]) =>
    h.div([h.Class("-m-8")], [pricingPrimaryCardSimple({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("pricing-primary-card-simple"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Pricing Sections/Pricing Primary Card Simple",
};
