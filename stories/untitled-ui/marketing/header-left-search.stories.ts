...
import { headerLeftSearch } from "../../../../../packages/ui/src/marketing/header-left-search.ts";
...
const SearchInput = m("HeaderLeftSearchSearchInput", { value: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model =>
    message._tag === "HeaderLeftSearchSearchInput"
      ? { ...model, searchValue: message.value }
      : model,
  view: (model: Model, h: Parameters<typeof headerLeftSearch<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [headerLeftSearch({ ...model, onSearch: (value) => SearchInput({ value }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("header-left-search"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Header Left Search",
};
