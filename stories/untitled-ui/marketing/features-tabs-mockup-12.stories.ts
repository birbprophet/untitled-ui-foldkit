...
import { featuresTabsMockup12 } from "../../../../../packages/ui/src/marketing/features-tabs-mockup-12.ts";
...
const TabSelected = m("FeaturesTabsMockup12TabSelected", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresTabsMockup12<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresTabsMockup12({ ...model, onSelect: (id) => TabSelected({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-tabs-mockup-12"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Tabs Mockup 12",
};
