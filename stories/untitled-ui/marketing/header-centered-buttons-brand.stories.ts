...
import { headerCenteredButtonsBrand } from "../../../../../packages/ui/src/marketing/header-centered-buttons-brand.ts";
...
const Primary = m("HeaderCenteredButtonsBrandPrimary");
const Secondary = m("HeaderCenteredButtonsBrandSecondary");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof headerCenteredButtonsBrand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [headerCenteredButtonsBrand({ ...model, onPrimary: Primary(), onSecondary: Secondary() }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("header-centered-buttons-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Header Centered Buttons Brand",
};
