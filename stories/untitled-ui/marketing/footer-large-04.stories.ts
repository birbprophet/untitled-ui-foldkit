...
import { footerLarge04 } from "../../../src/marketing/footer-large-04.ts";
...
const HomePressed = m("FooterLarge04HomePressed");
const LinkPressed = m("FooterLarge04LinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge04SocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge04LinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge04SocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge04<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge04(
...
export default {
  ...componentMeta("footer-large-04"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 04",
};
