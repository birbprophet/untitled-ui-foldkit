...
import { teamSectionImageCard01 } from "../../../../../packages/ui/src/marketing/team-section-image-card-01.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof teamSectionImageCard01>[1]) =>
    h.div([h.Class("-m-8")], [teamSectionImageCard01({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
