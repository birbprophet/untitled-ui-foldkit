...
import { pricingPrimaryDarkBadge } from "../../../../../packages/ui/src/marketing/pricing-primary-dark-badge.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof pricingPrimaryDarkBadge>[1]) =>
    h.div([h.Class("-m-8")], [pricingPrimaryDarkBadge({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("pricing-primary-dark-badge"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Pricing Sections/Pricing Primary Dark Badge",
};
