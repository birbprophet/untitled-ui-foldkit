...
import {
  faqAccordion04,
  faqAccordion04DefaultItems,
} from "../../../../../packages/ui/src/marketing/faq-accordion-04.ts";
...
const Cta = m("FaqAccordion04Cta");
const Toggle = m("FaqAccordion04Toggle", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FaqAccordion04Toggle") {
  ...
  view: (model: Model, h: Parameters<typeof faqAccordion04<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        faqAccordion04(
...
const args = {
  ...
  items: [...faqAccordion04DefaultItems],
} as const;

export default {
  ...componentMeta("faq-accordion-04"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Faq/Faq Accordion 04",
};
