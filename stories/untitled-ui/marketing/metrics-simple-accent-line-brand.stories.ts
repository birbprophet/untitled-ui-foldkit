...
import { metricsSimpleAccentLineBrand } from "../../../../../packages/ui/src/marketing/metrics-simple-accent-line-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof metricsSimpleAccentLineBrand>[1]) =>
    h.div([h.Class("-m-8")], [metricsSimpleAccentLineBrand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
