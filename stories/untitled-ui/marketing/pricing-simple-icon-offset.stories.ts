...
import { pricingSimpleIconOffset } from "../../../../../packages/ui/src/marketing/pricing-simple-icon-offset.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof pricingSimpleIconOffset>[1]) =>
    h.div([h.Class("-m-8")], [pricingSimpleIconOffset({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("pricing-simple-icon-offset"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Pricing Sections/Pricing Simple Icon Offset",
};
