...
import { heroCardMockup06 } from "../../../../../packages/ui/src/marketing/hero-card-mockup-06.ts";
...
const Primary = m("HeroCardMockup06Primary");
const Secondary = m("HeroCardMockup06Secondary");
const Navigated = m("HeroCardMockup06Navigated", { href: S.String });
const MobileOpened = m("HeroCardMockup06MobileOpened");
const MobileClosed = m("HeroCardMockup06MobileClosed");
const AccountPressed = m("HeroCardMockup06AccountPressed");
const SearchChanged = m("HeroCardMockup06SearchChanged", { value: S.String });
type Message =
  | typeof Primary.Type
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "HeroCardMockup06MobileOpened") {
      return { ...model, isMobileOpen: true };
    }
    if (message._tag === "HeroCardMockup06MobileClosed") {
      return { ...model, isMobileOpen: false };
    }
    if (message._tag === "HeroCardMockup06SearchChanged") {
      return { ...model, searchValue: message.value };
    }
    return model;
  },
  view: (model: Model, h: Parameters<typeof heroCardMockup06<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        heroCardMockup06(
...
export default {
  ...componentMeta("hero-card-mockup-06"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Hero Card Mockup 06",
};
