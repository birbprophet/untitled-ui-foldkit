...
import { featuresIconsAndMockup07 } from "../../../../../packages/ui/src/marketing/features-icons-and-mockup-07.ts";
...
const ItemPressed = m("FeaturesIconsAndMockup07ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresIconsAndMockup07<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresIconsAndMockup07({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-icons-and-mockup-07"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Icons And Mockup 07",
};
