...
import { testimonialSocialCards01Brand } from "../../../../../packages/ui/src/marketing/testimonial-social-cards-01-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialSocialCards01Brand>[1]) =>
    h.div([h.Class("-m-8")], [testimonialSocialCards01Brand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-social-cards-01-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Social Cards 01 Brand",
};
