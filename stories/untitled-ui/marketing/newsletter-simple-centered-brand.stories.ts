...
import { newsletterSimpleCenteredBrand } from "../../../../../packages/ui/src/marketing/newsletter-simple-centered-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof newsletterSimpleCenteredBrand>[1]) =>
    h.div([h.Class("-m-8")], [newsletterSimpleCenteredBrand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("newsletter-simple-centered-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Newsletter Cta/Newsletter Simple Centered Brand",
};
