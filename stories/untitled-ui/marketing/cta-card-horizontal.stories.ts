...
import { ctaCardHorizontal } from "../../../../../packages/ui/src/marketing/cta-card-horizontal.ts";
...
const Primary = m("CtaCardHorizontalPrimary");
const Secondary = m("CtaCardHorizontalSecondary");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof ctaCardHorizontal<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        ctaCardHorizontal(
...
export default {
  ...componentMeta("cta-card-horizontal"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Cta/Cta Card Horizontal",
};
