...
import { testimonialSocialCards01 } from "../../../../../packages/ui/src/marketing/testimonial-social-cards-01.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialSocialCards01>[1]) =>
    h.div([h.Class("-m-8")], [testimonialSocialCards01({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-social-cards-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Social Cards 01",
};
