...
import { footerSmall01Brand } from "../../../../../packages/ui/src/marketing/footer-small-01-brand.ts";
...
const Action = m("FooterSmall01BrandAction", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof footerSmall01Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [footerSmall01Brand({ ...model, onLink: (linkId) => Action({ id: linkId }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("footer-small-01-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Small 01 Brand",
};
