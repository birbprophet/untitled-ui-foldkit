...
import { heroIphoneMockup02 } from "../../../../../packages/ui/src/marketing/hero-iphone-mockup-02.ts";
...
const Primary = m("HeroIphoneMockup02Primary");
const Secondary = m("HeroIphoneMockup02Secondary");
const Navigated = m("HeroIphoneMockup02Navigated", { href: S.String });
const MobileOpened = m("HeroIphoneMockup02MobileOpened");
const MobileClosed = m("HeroIphoneMockup02MobileClosed");
const AccountPressed = m("HeroIphoneMockup02AccountPressed");
const SearchChanged = m("HeroIphoneMockup02SearchChanged", { value: S.String });
type Message =
  | typeof Primary.Type
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "HeroIphoneMockup02MobileOpened") {
      return { ...model, isMobileOpen: true };
    }
    if (message._tag === "HeroIphoneMockup02MobileClosed") {
      return { ...model, isMobileOpen: false };
    }
    if (message._tag === "HeroIphoneMockup02SearchChanged") {
      return { ...model, searchValue: message.value };
    }
    return model;
  },
  view: (model: Model, h: Parameters<typeof heroIphoneMockup02<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        heroIphoneMockup02(
...
export default {
  ...componentMeta("hero-iphone-mockup-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Hero Iphone Mockup 02",
};
