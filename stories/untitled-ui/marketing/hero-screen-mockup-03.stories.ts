...
import { heroScreenMockup03 } from "../../../../../packages/ui/src/marketing/hero-screen-mockup-03.ts";
...
const Primary = m("HeroScreenMockup03Primary");
const Secondary = m("HeroScreenMockup03Secondary");
const Navigated = m("HeroScreenMockup03Navigated", { href: S.String });
const MobileOpened = m("HeroScreenMockup03MobileOpened");
const MobileClosed = m("HeroScreenMockup03MobileClosed");
const AccountPressed = m("HeroScreenMockup03AccountPressed");
const SearchChanged = m("HeroScreenMockup03SearchChanged", { value: S.String });
type Message =
  | typeof Primary.Type
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "HeroScreenMockup03MobileOpened") {
      return { ...model, isMobileOpen: true };
    }
    if (message._tag === "HeroScreenMockup03MobileClosed") {
      return { ...model, isMobileOpen: false };
    }
    if (message._tag === "HeroScreenMockup03SearchChanged") {
      return { ...model, searchValue: message.value };
    }
    return model;
  },
  view: (model: Model, h: Parameters<typeof heroScreenMockup03<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        heroScreenMockup03(
...
export default {
  ...componentMeta("hero-screen-mockup-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Hero Screen Mockup 03",
};
