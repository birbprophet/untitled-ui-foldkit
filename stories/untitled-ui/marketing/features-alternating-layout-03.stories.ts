...
import { featuresAlternatingLayout03 } from "../../../../../packages/ui/src/marketing/features-alternating-layout-03.ts";
...
const ItemPressed = m("FeaturesAlternatingLayout03ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresAlternatingLayout03<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresAlternatingLayout03({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-alternating-layout-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Alternating Layout 03",
};
