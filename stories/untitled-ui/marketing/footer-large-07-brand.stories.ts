...
const HomePressed = m("FooterLarge07BrandHomePressed");
const LinkPressed = m("FooterLarge07BrandLinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge07BrandSocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge07BrandLinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge07BrandSocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge07Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge07Brand(
...
export default {
  ...componentMeta("footer-large-07-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 07 Brand",
};
