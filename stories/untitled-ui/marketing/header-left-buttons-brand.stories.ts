...
import { headerLeftButtonsBrand } from "../../../../../packages/ui/src/marketing/header-left-buttons-brand.ts";
...
const Primary = m("HeaderLeftButtonsBrandPrimary");
const Secondary = m("HeaderLeftButtonsBrandSecondary");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof headerLeftButtonsBrand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [headerLeftButtonsBrand({ ...model, onPrimary: Primary(), onSecondary: Secondary() }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("header-left-buttons-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Header Left Buttons Brand",
};
