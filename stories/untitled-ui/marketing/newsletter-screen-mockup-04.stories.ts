...
import { newsletterScreenMockup04 } from "../../../../../packages/ui/src/marketing/newsletter-screen-mockup-04.ts";
...
const Action = m("NewsletterScreenMockup04Action", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof newsletterScreenMockup04<Message>>[1]) =>
    h.div([h.Class("-m-8")], [newsletterScreenMockup04({ ...model, description: model.description, heading: model.heading, onAction: Action({ id: "action" }) }, h)]),
} as const;
...
export default {
  ...componentMeta("newsletter-screen-mockup-04"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Newsletter Cta/Newsletter Screen Mockup 04",
};
