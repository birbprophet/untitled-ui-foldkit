...
import { featuresTabsMockup01 } from "../../../../../packages/ui/src/marketing/features-tabs-mockup-01.ts";
...
const TabSelected = m("FeaturesTabsMockup01TabSelected", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresTabsMockup01<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresTabsMockup01({ ...model, onSelect: (id) => TabSelected({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-tabs-mockup-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Tabs Mockup 01",
};
