...
import { header } from "../../../../../packages/ui/src/marketing/header.ts";
...
const Action = m("HeaderAction", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof header<Message>>[1]) =>
    h.div([h.Class("-m-8")], [header({ ...model, description: model.description, heading: model.heading, onAction: Action({ id: "action" }) }, h)]),
} as const;
