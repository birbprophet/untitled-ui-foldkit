...
import { headerCentered } from "../../../../../packages/ui/src/marketing/header-centered.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof headerCentered<Message>>[1]) =>
    h.div([h.Class("-m-8")], [headerCentered({ ...model }, h)]),
} as const;
...
export default {
  ...componentMeta("header-centered"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Header Centered",
};
