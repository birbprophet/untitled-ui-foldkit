...
import { featuresAlternatingLayout02 } from "../../../../../packages/ui/src/marketing/features-alternating-layout-02.ts";
...
const ItemPressed = m("FeaturesAlternatingLayout02ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresAlternatingLayout02<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresAlternatingLayout02({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-alternating-layout-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Alternating Layout 02",
};
