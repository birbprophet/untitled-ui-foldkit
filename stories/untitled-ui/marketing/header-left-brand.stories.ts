...
import { headerLeftBrand } from "../../../../../packages/ui/src/marketing/header-left-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof headerLeftBrand<Message>>[1]) =>
    h.div([h.Class("-m-8")], [headerLeftBrand({ ...model }, h)]),
} as const;
...
export default {
  ...componentMeta("header-left-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Header Left Brand",
};
