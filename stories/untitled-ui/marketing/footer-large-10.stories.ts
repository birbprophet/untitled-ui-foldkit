...
const HomePressed = m("FooterLarge10HomePressed");
const LinkPressed = m("FooterLarge10LinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge10SocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge10HomePressed") {
      return { ...model, homeHref: "#home-opened" };
    }
    if (message._tag === "FooterLarge10LinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge10SocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge10<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge10(
...
export default {
  ...componentMeta("footer-large-10"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 10",
};
