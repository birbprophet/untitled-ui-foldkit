...
import { metricsSimpleCenteredTextBrand } from "../../../../../packages/ui/src/marketing/metrics-simple-centered-text-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof metricsSimpleCenteredTextBrand>[1]) =>
    h.div([h.Class("-m-8")], [metricsSimpleCenteredTextBrand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("metrics-simple-centered-text-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Metrics/Metrics Simple Centered Text Brand",
};
