...
import { socialProofFullWidthDualBrand } from "../../../../../packages/ui/src/marketing/social-proof-full-width-dual-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof socialProofFullWidthDualBrand>[1]) =>
    h.div([h.Class("-m-8")], [socialProofFullWidthDualBrand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("social-proof-full-width-dual-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Social Proof/Social Proof Full Width Dual Brand",
};
