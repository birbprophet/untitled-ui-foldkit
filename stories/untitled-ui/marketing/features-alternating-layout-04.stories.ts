...
import { featuresAlternatingLayout04 } from "../../../../../packages/ui/src/marketing/features-alternating-layout-04.ts";
...
const ItemPressed = m("FeaturesAlternatingLayout04ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresAlternatingLayout04<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresAlternatingLayout04({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-alternating-layout-04"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Alternating Layout 04",
};
