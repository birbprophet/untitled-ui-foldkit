...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof headerLeft<Message>>[1]) =>
    h.div([h.Class("-m-8")], [headerLeft({ ...model }, h)]),
} as const;
...
export default {
  ...componentMeta("header-left"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Header Left",
};
