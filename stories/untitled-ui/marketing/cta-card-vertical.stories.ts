...
const Primary = m("CtaCardVerticalPrimary");
const Secondary = m("CtaCardVerticalSecondary");
...
export default {
  ...componentMeta("cta-card-vertical"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Cta/Cta Card Vertical",
};
