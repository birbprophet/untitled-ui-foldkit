...
import { featuresTabsMockup06 } from "../../../../../packages/ui/src/marketing/features-tabs-mockup-06.ts";
...
const TabSelected = m("FeaturesTabsMockup06TabSelected", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresTabsMockup06<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresTabsMockup06({ ...model, onSelect: (id) => TabSelected({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-tabs-mockup-06"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Tabs Mockup 06",
};
