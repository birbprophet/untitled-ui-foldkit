...
import { heroScreenMockup07 } from "../../../../../packages/ui/src/marketing/hero-screen-mockup-07.ts";
...
const Primary = m("HeroScreenMockup07Primary");
const Secondary = m("HeroScreenMockup07Secondary");
const Navigated = m("HeroScreenMockup07Navigated", { href: S.String });
const MobileOpened = m("HeroScreenMockup07MobileOpened");
const MobileClosed = m("HeroScreenMockup07MobileClosed");
const AccountPressed = m("HeroScreenMockup07AccountPressed");
const SearchChanged = m("HeroScreenMockup07SearchChanged", { value: S.String });
type Message =
  | typeof Primary.Type
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "HeroScreenMockup07MobileOpened") {
      return { ...model, isMobileOpen: true };
    }
    if (message._tag === "HeroScreenMockup07MobileClosed") {
      return { ...model, isMobileOpen: false };
    }
    if (message._tag === "HeroScreenMockup07SearchChanged") {
      return { ...model, searchValue: message.value };
    }
    return model;
  },
  view: (model: Model, h: Parameters<typeof heroScreenMockup07<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        heroScreenMockup07(
...
export default {
  ...componentMeta("hero-screen-mockup-07"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Hero Screen Mockup 07",
};
