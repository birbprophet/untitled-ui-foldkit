...
import { ctaSimpleLogos02Brand } from "../../../../../packages/ui/src/marketing/cta-simple-logos-02-brand.ts";
...
export default { ...componentMeta("cta-simple-logos-02-brand"), parameters: { layout: "fullscreen" }, title: "Untitled UI/Marketing/Cta/Cta Simple Logos 02 Brand" };
