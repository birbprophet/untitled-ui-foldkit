...
import { heroIphoneMockup03 } from "../../../../../packages/ui/src/marketing/hero-iphone-mockup-03.ts";
...
const Primary = m("HeroIphoneMockup03Primary");
const Secondary = m("HeroIphoneMockup03Secondary");
const Navigated = m("HeroIphoneMockup03Navigated", { href: S.String });
const MobileOpened = m("HeroIphoneMockup03MobileOpened");
const MobileClosed = m("HeroIphoneMockup03MobileClosed");
const AccountPressed = m("HeroIphoneMockup03AccountPressed");
const SearchChanged = m("HeroIphoneMockup03SearchChanged", { value: S.String });
type Message =
  | typeof Primary.Type
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "HeroIphoneMockup03MobileOpened") {
      return { ...model, isMobileOpen: true };
    }
    if (message._tag === "HeroIphoneMockup03MobileClosed") {
      return { ...model, isMobileOpen: false };
    }
    if (message._tag === "HeroIphoneMockup03SearchChanged") {
      return { ...model, searchValue: message.value };
    }
    return model;
  },
  view: (model: Model, h: Parameters<typeof heroIphoneMockup03<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        heroIphoneMockup03(
...
export default {
  ...componentMeta("hero-iphone-mockup-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Hero Iphone Mockup 03",
};
