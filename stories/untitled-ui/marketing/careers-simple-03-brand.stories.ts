...
import { careersSimple03Brand } from "../../../../../packages/ui/src/marketing/careers-simple-03-brand.ts";
...
const Selected = m("CareersSimple03BrandJobSelected", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof careersSimple03Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [careersSimple03Brand({ ...model, onJob: (id) => Selected({ id }) }, h)],
    ),
} as const;
const jobs = [
  {
...
export default {
  ...componentMeta("careers-simple-03-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Careers/Careers Simple 03 Brand",
};
