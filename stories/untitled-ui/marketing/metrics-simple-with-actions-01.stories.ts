...
import { metricsSimpleWithActions01 } from "../../../../../packages/ui/src/marketing/metrics-simple-with-actions-01.ts";
...
const Action = m("MetricsSimpleWithActions01Action", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof metricsSimpleWithActions01<Message>>[1]) =>
    h.div([h.Class("-m-8")], [metricsSimpleWithActions01({ ...model, description: model.description, heading: model.heading, onAction: Action({ id: "action" }) }, h)]),
} as const;
...
export default {
  ...componentMeta("metrics-simple-with-actions-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Metrics/Metrics Simple With Actions 01",
};
