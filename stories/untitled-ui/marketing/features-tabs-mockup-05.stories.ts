...
import { featuresTabsMockup05 } from "../../../../../packages/ui/src/marketing/features-tabs-mockup-05.ts";
...
const TabSelected = m("FeaturesTabsMockup05TabSelected", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresTabsMockup05<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresTabsMockup05({ ...model, onSelect: (id) => TabSelected({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-tabs-mockup-05"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Tabs Mockup 05",
};
