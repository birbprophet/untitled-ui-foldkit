...
import { featuresIconsAndImage03 } from "../../../../../packages/ui/src/marketing/features-icons-and-image-03.ts";
...
const ItemPressed = m("FeaturesIconsAndImage03ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresIconsAndImage03<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresIconsAndImage03({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-icons-and-image-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Icons And Image 03",
};
