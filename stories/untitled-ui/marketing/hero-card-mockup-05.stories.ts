...
import { heroCardMockup05 } from "../../../../../packages/ui/src/marketing/hero-card-mockup-05.ts";
...
const Primary = m("HeroCardMockup05Primary");
const Secondary = m("HeroCardMockup05Secondary");
const Navigated = m("HeroCardMockup05Navigated", { href: S.String });
const MobileOpened = m("HeroCardMockup05MobileOpened");
const MobileClosed = m("HeroCardMockup05MobileClosed");
const AccountPressed = m("HeroCardMockup05AccountPressed");
const SearchChanged = m("HeroCardMockup05SearchChanged", { value: S.String });
type Message =
  | typeof Primary.Type
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "HeroCardMockup05MobileOpened") {
      return { ...model, isMobileOpen: true };
    }
    if (message._tag === "HeroCardMockup05MobileClosed") {
      return { ...model, isMobileOpen: false };
    }
    if (message._tag === "HeroCardMockup05SearchChanged") {
      return { ...model, searchValue: message.value };
    }
    return model;
  },
  view: (model: Model, h: Parameters<typeof heroCardMockup05<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        heroCardMockup05(
...
export default {
  ...componentMeta("hero-card-mockup-05"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Hero Card Mockup 05",
};
