...
import {
  faqSimple03Brand,
  faqSimple03BrandDefaultItems,
} from "../../../../../packages/ui/src/marketing/faq-simple-03-brand.ts";
...
const Cta = m("FaqSimple03BrandCta");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof faqSimple03Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        faqSimple03Brand(
...
const args = {
  ...
  items: [...faqSimple03BrandDefaultItems],
} as const;

export default {
  ...componentMeta("faq-simple-03-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Faq/Faq Simple 03 Brand",
};
