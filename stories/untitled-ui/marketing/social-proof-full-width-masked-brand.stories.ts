...
import { socialProofFullWidthMaskedBrand } from "../../../../../packages/ui/src/marketing/social-proof-full-width-masked-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof socialProofFullWidthMaskedBrand>[1]) =>
    h.div([h.Class("-m-8")], [socialProofFullWidthMaskedBrand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("social-proof-full-width-masked-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Social Proof/Social Proof Full Width Masked Brand",
};
