...
import { teamSectionImageGlass03 } from "../../../../../packages/ui/src/marketing/team-section-image-glass-03.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof teamSectionImageGlass03>[1]) =>
    h.div([h.Class("-m-8")], [teamSectionImageGlass03({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("team-section-image-glass-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Team Sections/Team Section Image Glass 03",
};
