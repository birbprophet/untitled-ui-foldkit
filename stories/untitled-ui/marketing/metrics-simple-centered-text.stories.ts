...
import { metricsSimpleCenteredText } from "../../../../../packages/ui/src/marketing/metrics-simple-centered-text.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof metricsSimpleCenteredText>[1]) =>
    h.div([h.Class("-m-8")], [metricsSimpleCenteredText({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("metrics-simple-centered-text"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Metrics/Metrics Simple Centered Text",
};
