...
import { testimonialCardSplitImage } from "../../../../../packages/ui/src/marketing/testimonial-card-split-image.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialCardSplitImage>[1]) =>
    h.div([h.Class("-m-8")], [testimonialCardSplitImage({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-card-split-image"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Card Split Image",
};
