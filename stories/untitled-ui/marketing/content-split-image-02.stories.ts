...
import { contentSplitImage02 } from "../../../../../packages/ui/src/marketing/content-split-image-02.ts";
...
const specimen = (props: Args, h: Parameters<typeof contentSplitImage02>[1]) =>
  h.div([h.Class("-m-8")], [contentSplitImage02(props, h)]);

export default {
  ...componentMeta("content-split-image-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Content/Content Split Image 02",
};
