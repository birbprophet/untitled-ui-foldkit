...
import { socialProofFullWidthBrand } from "../../../../../packages/ui/src/marketing/social-proof-full-width-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof socialProofFullWidthBrand>[1]) =>
    h.div([h.Class("-m-8")], [socialProofFullWidthBrand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("social-proof-full-width-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Social Proof/Social Proof Full Width Brand",
};
