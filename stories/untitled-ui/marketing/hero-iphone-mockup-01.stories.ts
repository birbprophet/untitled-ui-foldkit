...
import { heroIphoneMockup01 } from "../../../../../packages/ui/src/marketing/hero-iphone-mockup-01.ts";
...
const Primary = m("HeroIphoneMockup01Primary");
const Secondary = m("HeroIphoneMockup01Secondary");
const Navigated = m("HeroIphoneMockup01Navigated", { href: S.String });
const MobileOpened = m("HeroIphoneMockup01MobileOpened");
const MobileClosed = m("HeroIphoneMockup01MobileClosed");
const AccountPressed = m("HeroIphoneMockup01AccountPressed");
const SearchChanged = m("HeroIphoneMockup01SearchChanged", { value: S.String });
type Message =
  | typeof Primary.Type
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "HeroIphoneMockup01MobileOpened") {
      return { ...model, isMobileOpen: true };
    }
    if (message._tag === "HeroIphoneMockup01MobileClosed") {
      return { ...model, isMobileOpen: false };
    }
    if (message._tag === "HeroIphoneMockup01SearchChanged") {
      return { ...model, searchValue: message.value };
    }
    return model;
  },
  view: (model: Model, h: Parameters<typeof heroIphoneMockup01<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        heroIphoneMockup01(
...
export default {
  ...componentMeta("hero-iphone-mockup-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Hero Iphone Mockup 01",
};
