...
import { contentSectionSplitImage03 } from "../../../../../packages/ui/src/marketing/content-section-split-image-03.ts";
import { componentMeta, liveStory, waitForStoryReady } from "../story.ts";

const Args = S.Struct({ imageAlt: S.String,
  imageSrc: S.String,
  primaryLabel: S.String,
  secondaryLabel: S.String });
const Model = Args;
type Model = typeof Model.Type;
const Primary = m("ContentSectionSplitImage03Primary");
const Secondary = m("ContentSectionSplitImage03Secondary");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof contentSectionSplitImage03<Message>>[1]) =>
    h.div([h.Class("-m-8")], [contentSectionSplitImage03({ ...model, ...actions }, h)]),
} as const;

const args = { imageAlt: "Marketing image", imageSrc: "https://www.untitledui.com/marketing/content-section-03.webp", primaryLabel: "Read case study", secondaryLabel: "Chat to us" } as const;

export default { ...componentMeta("content-section-split-image-03"), parameters: { layout: "fullscreen" }, title: "Untitled UI/Marketing/Content/Content Section Split Image 03" };
