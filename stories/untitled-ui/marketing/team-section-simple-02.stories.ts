...
import { teamSectionSimple02 } from "../../../../../packages/ui/src/marketing/team-section-simple-02.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof teamSectionSimple02>[1]) =>
    h.div([h.Class("-m-8")], [teamSectionSimple02({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
