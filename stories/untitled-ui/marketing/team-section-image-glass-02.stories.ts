...
import { teamSectionImageGlass02 } from "../../../../../packages/ui/src/marketing/team-section-image-glass-02.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof teamSectionImageGlass02>[1]) =>
    h.div([h.Class("-m-8")], [teamSectionImageGlass02({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
