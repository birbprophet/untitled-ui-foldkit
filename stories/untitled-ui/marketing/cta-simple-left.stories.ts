...
import { ctaSimpleLeft } from "../../../../../packages/ui/src/marketing/cta-simple-left.ts";
...
export default { ...componentMeta("cta-simple-left"), parameters: { layout: "fullscreen" }, title: "Untitled UI/Marketing/Cta/Cta Simple Left" };
