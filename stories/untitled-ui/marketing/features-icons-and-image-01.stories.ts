...
import { featuresIconsAndImage01 } from "../../../../../packages/ui/src/marketing/features-icons-and-image-01.ts";
...
const ItemPressed = m("FeaturesIconsAndImage01ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresIconsAndImage01<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresIconsAndImage01({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-icons-and-image-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Icons And Image 01",
};
