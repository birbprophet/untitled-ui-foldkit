...
import { menuBlogPostsWithFooter } from "../../../../../packages/ui/src/marketing/menu-blog-posts-with-footer.ts";
...
const Action = m("MenuBlogPostsWithFooterAction", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof menuBlogPostsWithFooter<Message>>[1]) =>
    h.div([h.Class("-m-8")], [menuBlogPostsWithFooter({ ...model, description: model.description, heading: model.heading, onAction: Action({ id: "action" }) }, h)]),
} as const;
