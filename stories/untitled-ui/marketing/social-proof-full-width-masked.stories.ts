...
import { socialProofFullWidthMasked } from "../../../../../packages/ui/src/marketing/social-proof-full-width-masked.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof socialProofFullWidthMasked>[1]) =>
    h.div([h.Class("-m-8")], [socialProofFullWidthMasked({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("social-proof-full-width-masked"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Social Proof/Social Proof Full Width Masked",
};
