...
import { testimonialSimpleCentered03Brand } from "../../../../../packages/ui/src/marketing/testimonial-simple-centered-03-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialSimpleCentered03Brand>[1]) =>
    h.div([h.Class("-m-8")], [testimonialSimpleCentered03Brand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-simple-centered-03-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Simple Centered 03 Brand",
};
