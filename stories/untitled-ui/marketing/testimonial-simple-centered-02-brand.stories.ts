...
import { testimonialSimpleCentered02Brand } from "../../../../../packages/ui/src/marketing/testimonial-simple-centered-02-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialSimpleCentered02Brand>[1]) =>
    h.div([h.Class("-m-8")], [testimonialSimpleCentered02Brand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-simple-centered-02-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Simple Centered 02 Brand",
};
