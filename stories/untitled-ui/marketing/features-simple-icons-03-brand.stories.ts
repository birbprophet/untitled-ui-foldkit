...
import { featuresSimpleIcons03Brand } from "../../../../../packages/ui/src/marketing/features-simple-icons-03-brand.ts";
...
const ItemPressed = m("FeaturesSimpleIcons03BrandItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresSimpleIcons03Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresSimpleIcons03Brand({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-simple-icons-03-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Simple Icons 03 Brand",
};
