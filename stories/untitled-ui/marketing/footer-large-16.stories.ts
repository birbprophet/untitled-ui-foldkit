...
import { footerLarge16 } from "../../../../../packages/ui/src/marketing/footer-large-16.ts";
...
const Action = m("FooterLarge16Action", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof footerLarge16<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge16(
...
const args = {
  ...
  formId: "footer-large-16-form",
  subscribeLabel: "Subscribe",
} as const;

export default {
  ...componentMeta("footer-large-16"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 16",
};
