...
import { ctaScreenMockup01 } from "../../../../../packages/ui/src/marketing/cta-screen-mockup-01.ts";
...
const Primary = m("CtaScreenMockup01Primary");
const Secondary = m("CtaScreenMockup01Secondary");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof ctaScreenMockup01<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        ctaScreenMockup01(
...
export default {
  ...componentMeta("cta-screen-mockup-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Cta/Cta Screen Mockup 01",
};
