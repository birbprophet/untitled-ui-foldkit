...
import { featuresIconsAndMockup03 } from "../../../../../packages/ui/src/marketing/features-icons-and-mockup-03.ts";
...
const ItemPressed = m("FeaturesIconsAndMockup03ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresIconsAndMockup03<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresIconsAndMockup03({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-icons-and-mockup-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Icons And Mockup 03",
};
