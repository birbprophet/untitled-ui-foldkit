...
const HomePressed = m("FooterLarge02HomePressed");
const LinkPressed = m("FooterLarge02LinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge02SocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge02LinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge02SocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge02<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge02(
...
export default {
  ...componentMeta("footer-large-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 02",
};
