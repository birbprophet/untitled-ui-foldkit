...
import { heroCardMockup09 } from "../../../../../packages/ui/src/marketing/hero-card-mockup-09.ts";
...
const Primary = m("HeroCardMockup09Primary");
const Secondary = m("HeroCardMockup09Secondary");
const Navigated = m("HeroCardMockup09Navigated", { href: S.String });
const MobileOpened = m("HeroCardMockup09MobileOpened");
const MobileClosed = m("HeroCardMockup09MobileClosed");
const AccountPressed = m("HeroCardMockup09AccountPressed");
const SearchChanged = m("HeroCardMockup09SearchChanged", { value: S.String });
type Message =
  | typeof Primary.Type
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "HeroCardMockup09MobileOpened") {
      return { ...model, isMobileOpen: true };
    }
    if (message._tag === "HeroCardMockup09MobileClosed") {
      return { ...model, isMobileOpen: false };
    }
    if (message._tag === "HeroCardMockup09SearchChanged") {
      return { ...model, searchValue: message.value };
    }
    return model;
  },
  view: (model: Model, h: Parameters<typeof heroCardMockup09<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        heroCardMockup09(
...
export default {
  ...componentMeta("hero-card-mockup-09"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Hero Card Mockup 09",
};
