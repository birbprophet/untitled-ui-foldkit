...
import { metricsMinimalCenteredText } from "../../../../../packages/ui/src/marketing/metrics-minimal-centered-text.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof metricsMinimalCenteredText>[1]) =>
    h.div([h.Class("-m-8")], [metricsMinimalCenteredText({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("metrics-minimal-centered-text"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Metrics/Metrics Minimal Centered Text",
};
