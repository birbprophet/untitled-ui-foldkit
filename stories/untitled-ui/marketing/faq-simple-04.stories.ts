...
import { faqSimple04, faqSimple04DefaultItems } from "../../../src/marketing/faq-simple-04.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof faqSimple04<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        faqSimple04(
...
const args = {
  ...
  items: [...faqSimple04DefaultItems],
} as const;

export default {
  ...componentMeta("faq-simple-04"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Faq/Faq Simple 04",
};
