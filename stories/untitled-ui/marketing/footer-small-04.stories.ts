...
import { footerSmall04 } from "../../../../../packages/ui/src/marketing/footer-small-04.ts";
...
const Action = m("FooterSmall04Action", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof footerSmall04<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerSmall04(
...
const args = {
  ...
  formId: "footer-small-04-form",
  subscribeLabel: "Subscribe",
} as const;

export default {
  ...componentMeta("footer-small-04"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Small 04",
};
