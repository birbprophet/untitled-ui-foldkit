...
import { testimonialSimpleCentered01 } from "../../../../../packages/ui/src/marketing/testimonial-simple-centered-01.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialSimpleCentered01>[1]) =>
    h.div([h.Class("-m-8")], [testimonialSimpleCentered01({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-simple-centered-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Simple Centered 01",
};
