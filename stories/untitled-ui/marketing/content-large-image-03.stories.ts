...
import { contentLargeImage03 } from "../../../../../packages/ui/src/marketing/content-large-image-03.ts";
...
const CopyLink = m("ContentLargeImage03CopyLink");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof contentLargeImage03<Message>>[1]) =>
    h.div([h.Class("-m-8")], [contentLargeImage03({ ...model, ...actions }, h)]),
} as const;

import { contentLargeImage03Defaults } from "../../../../../packages/ui/src/marketing/content-large-image-03.ts";

const args = { ...contentLargeImage03Defaults } as const;

export default { ...componentMeta("content-large-image-03"), parameters: { layout: "fullscreen" }, title: "Untitled UI/Marketing/Content/Content Large Image 03" };
