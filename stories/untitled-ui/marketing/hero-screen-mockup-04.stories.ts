...
import { heroScreenMockup04 } from "../../../../../packages/ui/src/marketing/hero-screen-mockup-04.ts";
...
const Primary = m("HeroScreenMockup04Primary");
const Secondary = m("HeroScreenMockup04Secondary");
const Navigated = m("HeroScreenMockup04Navigated", { href: S.String });
const MobileOpened = m("HeroScreenMockup04MobileOpened");
const MobileClosed = m("HeroScreenMockup04MobileClosed");
const AccountPressed = m("HeroScreenMockup04AccountPressed");
const SearchChanged = m("HeroScreenMockup04SearchChanged", { value: S.String });
type Message =
  | typeof Primary.Type
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "HeroScreenMockup04MobileOpened") {
      return { ...model, isMobileOpen: true };
    }
    if (message._tag === "HeroScreenMockup04MobileClosed") {
      return { ...model, isMobileOpen: false };
    }
    if (message._tag === "HeroScreenMockup04SearchChanged") {
      return { ...model, searchValue: message.value };
    }
    return model;
  },
  view: (model: Model, h: Parameters<typeof heroScreenMockup04<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        heroScreenMockup04(
...
export default {
  ...componentMeta("hero-screen-mockup-04"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Hero Screen Mockup 04",
};
