...
import { contentLargeImage01 } from "../../../../../packages/ui/src/marketing/content-large-image-01.ts";
...
import { contentLargeImage01Defaults } from "../../../../../packages/ui/src/marketing/content-large-image-01.ts";

const args = { ...contentLargeImage01Defaults } as const;

export default { ...componentMeta("content-large-image-01"), parameters: { layout: "fullscreen" }, title: "Untitled UI/Marketing/Content/Content Large Image 01" };
