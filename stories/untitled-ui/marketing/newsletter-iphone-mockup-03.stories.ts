...
import { newsletterIphoneMockup03 } from "../../../../../packages/ui/src/marketing/newsletter-iphone-mockup-03.ts";
...
const Action = m("NewsletterIphoneMockup03Action", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof newsletterIphoneMockup03<Message>>[1]) =>
    h.div([h.Class("-m-8")], [newsletterIphoneMockup03({ ...model, description: model.description, heading: model.heading, onAction: Action({ id: "action" }) }, h)]),
} as const;
...
export default {
  ...componentMeta("newsletter-iphone-mockup-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Newsletter Cta/Newsletter Iphone Mockup 03",
};
