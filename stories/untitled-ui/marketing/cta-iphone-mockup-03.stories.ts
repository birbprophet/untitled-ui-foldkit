...
import { ctaIphoneMockup03 } from "../../../../../packages/ui/src/marketing/cta-iphone-mockup-03.ts";
...
const Action = m("CtaIphoneMockup03Action");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof ctaIphoneMockup03<Message>>[1]) =>
    h.div([h.Class("-m-8")], [ctaIphoneMockup03({ ...model, onAction: Action() }, h)]),
} as const;
...
export default {
  ...componentMeta("cta-iphone-mockup-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Cta/Cta Iphone Mockup 03",
};
