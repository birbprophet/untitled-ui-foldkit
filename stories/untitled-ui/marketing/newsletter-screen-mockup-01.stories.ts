...
import { newsletterScreenMockup01 } from "../../../../../packages/ui/src/marketing/newsletter-screen-mockup-01.ts";
...
const Action = m("NewsletterScreenMockup01Action", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof newsletterScreenMockup01<Message>>[1]) =>
    h.div([h.Class("-m-8")], [newsletterScreenMockup01({ ...model, description: model.description, heading: model.heading, onAction: Action({ id: "action" }) }, h)]),
} as const;
...
export default {
  ...componentMeta("newsletter-screen-mockup-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Newsletter Cta/Newsletter Screen Mockup 01",
};
