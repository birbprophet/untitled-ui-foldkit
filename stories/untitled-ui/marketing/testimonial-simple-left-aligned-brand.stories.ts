...
import { testimonialSimpleLeftAlignedBrand } from "../../../../../packages/ui/src/marketing/testimonial-simple-left-aligned-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialSimpleLeftAlignedBrand>[1]) =>
    h.div([h.Class("-m-8")], [testimonialSimpleLeftAlignedBrand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-simple-left-aligned-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Simple Left Aligned Brand",
};
