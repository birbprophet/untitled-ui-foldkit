...
import { teamSectionSimple04 } from "../../../../../packages/ui/src/marketing/team-section-simple-04.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof teamSectionSimple04>[1]) =>
    h.div([h.Class("-m-8")], [teamSectionSimple04({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
