...
import { testimonialCard } from "../../../../../packages/ui/src/marketing/testimonial-card.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialCard>[1]) =>
    h.div([h.Class("-m-8")], [testimonialCard({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
