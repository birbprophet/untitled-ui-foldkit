...
import { footerLarge08 } from "../../../src/marketing/footer-large-08.ts";
...
const HomePressed = m("FooterLarge08HomePressed");
const LinkPressed = m("FooterLarge08LinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge08SocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge08LinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge08SocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge08<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge08(
...
export default {
  ...componentMeta("footer-large-08"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 08",
};
