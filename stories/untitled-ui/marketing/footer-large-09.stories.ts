...
const HomePressed = m("FooterLarge09HomePressed");
const LinkPressed = m("FooterLarge09LinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge09SocialPressed", { id: S.String });
...
export default {
  ...componentMeta("footer-large-09"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 09",
};
