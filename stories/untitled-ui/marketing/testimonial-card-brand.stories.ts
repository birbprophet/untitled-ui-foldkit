...
import { testimonialCardBrand } from "../../../../../packages/ui/src/marketing/testimonial-card-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialCardBrand>[1]) =>
    h.div([h.Class("-m-8")], [testimonialCardBrand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-card-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Card Brand",
};
