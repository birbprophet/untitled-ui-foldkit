...
import { pricingSimpleCallOut } from "../../../../../packages/ui/src/marketing/pricing-simple-call-out.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof pricingSimpleCallOut>[1]) =>
    h.div([h.Class("-m-8")], [pricingSimpleCallOut({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("pricing-simple-call-out"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Pricing Sections/Pricing Simple Call Out",
};
