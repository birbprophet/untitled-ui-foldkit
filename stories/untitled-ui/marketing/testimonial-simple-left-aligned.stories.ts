...
import { testimonialSimpleLeftAligned } from "../../../../../packages/ui/src/marketing/testimonial-simple-left-aligned.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialSimpleLeftAligned>[1]) =>
    h.div([h.Class("-m-8")], [testimonialSimpleLeftAligned({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-simple-left-aligned"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Simple Left Aligned",
};
