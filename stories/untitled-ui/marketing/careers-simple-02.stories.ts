...
import { careersSimple02 } from "../../../../../packages/ui/src/marketing/careers-simple-02.ts";
...
const Selected = m("CareersSimple02JobSelected", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof careersSimple02<Message>>[1]) =>
    h.div([h.Class("-m-8")], [careersSimple02({ ...model, onJob: (id) => Selected({ id }) }, h)]),
} as const;
const jobs = [
  {
    badgeColor: "blue",
...
export default {
  ...componentMeta("careers-simple-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Careers/Careers Simple 02",
};
