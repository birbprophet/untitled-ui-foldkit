...
import { featuresCenterMockup02 } from "../../../../../packages/ui/src/marketing/features-center-mockup-02.ts";
...
const ItemPressed = m("FeaturesCenterMockup02ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresCenterMockup02<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresCenterMockup02({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-center-mockup-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Center Mockup 02",
};
