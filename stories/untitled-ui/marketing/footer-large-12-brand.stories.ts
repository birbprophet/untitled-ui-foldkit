...
import { footerLarge12Brand } from "../../../src/marketing/footer-large-12-brand.ts";
...
const HomePressed = m("FooterLarge12BrandHomePressed");
const LinkPressed = m("FooterLarge12BrandLinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge12BrandSocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge12BrandHomePressed") {
      return { ...model, homeHref: "#home-opened" };
    }
    if (message._tag === "FooterLarge12BrandLinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge12BrandSocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge12Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge12Brand(
...
export default {
  ...componentMeta("footer-large-12-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 12 Brand",
};
