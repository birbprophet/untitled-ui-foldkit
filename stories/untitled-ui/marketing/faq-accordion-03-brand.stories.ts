...
import {
  faqAccordion03Brand,
  faqAccordion03BrandDefaultItems,
} from "../../../../../packages/ui/src/marketing/faq-accordion-03-brand.ts";
...
const Cta = m("FaqAccordion03BrandCta");
const Toggle = m("FaqAccordion03BrandToggle", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FaqAccordion03BrandToggle") {
  ...
  view: (model: Model, h: Parameters<typeof faqAccordion03Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        faqAccordion03Brand(
...
const args = {
  ...
  items: [...faqAccordion03BrandDefaultItems],
} as const;

export default {
  ...componentMeta("faq-accordion-03-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Faq/Faq Accordion 03 Brand",
};
