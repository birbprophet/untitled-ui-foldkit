...
import { bannerCountdownDefault } from "../../../../../packages/ui/src/marketing/banner-countdown-default.ts";
...
const Dismissed = m("BannerCountdownDefaultDismissed");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof bannerCountdownDefault<Message>>[1]) =>
    model.isVisible
      ? bannerCountdownDefault({ ...model, onDismiss: Dismissed() }, h)
...
export default {
  ...componentMeta("banner-countdown-default"),
  title: "Untitled UI/Marketing/Banners/Banner Countdown Default",
};
