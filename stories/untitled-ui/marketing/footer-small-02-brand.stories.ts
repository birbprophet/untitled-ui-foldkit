...
const HomePressed = m("FooterSmall02BrandHomePressed");
const LinkPressed = m("FooterSmall02BrandLinkPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof footerSmall02Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerSmall02Brand(
