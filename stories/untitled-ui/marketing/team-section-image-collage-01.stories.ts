...
const section = (args: SectionArgs, h: HtmlBuilder<{ readonly _tag: "Noop" }>) =>
  h.div([h.Class("-m-8")], [teamSectionImageCollage01(args, h)]);
...
const args = {
  ...
  description: "We're a distributed team on a mission to make great design accessible to everyone.",
  eyebrow: "Our team",
  heading: "The people behind Siglata",
} as const;
...
export const Interactions = {
  ...
  play: async ({ canvasElement }: { readonly canvasElement: HTMLElement }) => {
    ...
    await expect(canvas.getByRole("heading")).toHaveTextContent("The people behind Siglata");
  },
};
