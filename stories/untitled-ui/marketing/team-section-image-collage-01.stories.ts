...
import { teamSectionImageCollage01 } from "../../../../../packages/ui/src/marketing/team-section-image-collage-01.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof teamSectionImageCollage01>[1]) =>
    h.div([h.Class("-m-8")], [teamSectionImageCollage01({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("team-section-image-collage-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Team Sections/Team Section Image Collage 01",
};
