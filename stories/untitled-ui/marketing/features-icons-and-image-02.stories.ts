...
import { featuresIconsAndImage02 } from "../../../../../packages/ui/src/marketing/features-icons-and-image-02.ts";
...
const ItemPressed = m("FeaturesIconsAndImage02ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresIconsAndImage02<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresIconsAndImage02({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-icons-and-image-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Icons And Image 02",
};
