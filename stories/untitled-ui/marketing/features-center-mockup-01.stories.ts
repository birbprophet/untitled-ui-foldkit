...
import { featuresCenterMockup01 } from "../../../../../packages/ui/src/marketing/features-center-mockup-01.ts";
...
const ItemPressed = m("FeaturesCenterMockup01ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresCenterMockup01<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresCenterMockup01({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-center-mockup-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Center Mockup 01",
};
