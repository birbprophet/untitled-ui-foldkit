...
import { socialProofCardBrand } from "../../../../../packages/ui/src/marketing/social-proof-card-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof socialProofCardBrand>[1]) =>
    h.div([h.Class("-m-8")], [socialProofCardBrand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("social-proof-card-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Social Proof/Social Proof Card Brand",
};
