...
import { testimonialSplitImage02 } from "../../../../../packages/ui/src/marketing/testimonial-split-image-02.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialSplitImage02>[1]) =>
    h.div([h.Class("-m-8")], [testimonialSplitImage02({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-split-image-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Split Image 02",
};
