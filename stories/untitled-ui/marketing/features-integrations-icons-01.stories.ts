...
import { featuresIntegrationsIcons01 } from "../../../../../packages/ui/src/marketing/features-integrations-icons-01.ts";
...
const ItemPressed = m("FeaturesIntegrationsIcons01ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresIntegrationsIcons01<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresIntegrationsIcons01({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-integrations-icons-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Integrations Icons 01",
};
