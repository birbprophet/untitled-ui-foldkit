...
import { pricingSectionFeaturedCards04 } from "../../../../../packages/ui/src/marketing/pricing-section-featured-cards-04.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof pricingSectionFeaturedCards04>[1]) =>
    h.div([h.Class("-m-8")], [pricingSectionFeaturedCards04({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("pricing-section-featured-cards-04"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Pricing Sections/Pricing Section Featured Cards 04",
};
