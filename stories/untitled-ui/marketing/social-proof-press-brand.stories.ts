...
import { socialProofPressBrand } from "../../../../../packages/ui/src/marketing/social-proof-press-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof socialProofPressBrand>[1]) =>
    h.div([h.Class("-m-8")], [socialProofPressBrand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("social-proof-press-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Social Proof/Social Proof Press Brand",
};
