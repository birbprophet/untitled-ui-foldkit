...
import { newsletterScreenMockup02 } from "../../../../../packages/ui/src/marketing/newsletter-screen-mockup-02.ts";
...
const Action = m("NewsletterScreenMockup02Action", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof newsletterScreenMockup02<Message>>[1]) =>
    h.div([h.Class("-m-8")], [newsletterScreenMockup02({ ...model, description: model.description, heading: model.heading, onAction: Action({ id: "action" }) }, h)]),
} as const;
...
export default {
  ...componentMeta("newsletter-screen-mockup-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Newsletter Cta/Newsletter Screen Mockup 02",
};
