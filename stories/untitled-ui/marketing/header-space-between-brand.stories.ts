...
import { headerSpaceBetweenBrand } from "../../../../../packages/ui/src/marketing/header-space-between-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof headerSpaceBetweenBrand<Message>>[1]) =>
    h.div([h.Class("-m-8")], [headerSpaceBetweenBrand({ ...model }, h)]),
} as const;
...
export default {
  ...componentMeta("header-space-between-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Header Space Between Brand",
};
