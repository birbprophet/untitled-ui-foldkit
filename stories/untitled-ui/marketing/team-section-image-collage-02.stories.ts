...
import { teamSectionImageCollage02 } from "../../../../../packages/ui/src/marketing/team-section-image-collage-02.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof teamSectionImageCollage02>[1]) =>
    h.div([h.Class("-m-8")], [teamSectionImageCollage02({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("team-section-image-collage-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Team Sections/Team Section Image Collage 02",
};
