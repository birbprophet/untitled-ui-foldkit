...
import { newsletterCardVerticalBrand } from "../../../../../packages/ui/src/marketing/newsletter-card-vertical-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof newsletterCardVerticalBrand>[1]) =>
    h.div([h.Class("-m-8")], [newsletterCardVerticalBrand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("newsletter-card-vertical-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Newsletter Cta/Newsletter Card Vertical Brand",
};
