...
import { metricsSplitImage01Brand } from "../../../../../packages/ui/src/marketing/metrics-split-image-01-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof metricsSplitImage01Brand>[1]) =>
    h.div([h.Class("-m-8")], [metricsSplitImage01Brand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("metrics-split-image-01-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Metrics/Metrics Split Image 01 Brand",
};
