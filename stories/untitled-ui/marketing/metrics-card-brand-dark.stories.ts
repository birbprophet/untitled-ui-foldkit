...
import { metricsCardBrandDark } from "../../../../../packages/ui/src/marketing/metrics-card-brand-dark.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof metricsCardBrandDark>[1]) =>
    h.div([h.Class("-m-8")], [metricsCardBrandDark({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("metrics-card-brand-dark"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Metrics/Metrics Card Brand Dark",
};
