...
import { featuresSimpleIcons01 } from "../../../../../packages/ui/src/marketing/features-simple-icons-01.ts";
...
const ItemPressed = m("FeaturesSimpleIcons01ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresSimpleIcons01<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresSimpleIcons01({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-simple-icons-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Simple Icons 01",
};
