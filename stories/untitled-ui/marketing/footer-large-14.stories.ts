...
import { footerLarge14 } from "../../../../../packages/ui/src/marketing/footer-large-14.ts";
...
const Action = m("FooterLarge14Action", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof footerLarge14<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [footerLarge14({ ...model, onLink: (linkId) => Action({ id: linkId }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("footer-large-14"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 14",
};
