...
import { footerLarge15 } from "../../../../../packages/ui/src/marketing/footer-large-15.ts";
...
const Action = m("FooterLarge15Action", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof footerLarge15<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [footerLarge15({ ...model, onLink: (linkId) => Action({ id: linkId }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("footer-large-15"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 15",
};
