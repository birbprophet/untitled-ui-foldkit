...
import { menu2ColWithLinks } from "../../../../../packages/ui/src/marketing/menu-2-col-with-links.ts";
...
const Action = m("Menu2ColWithLinksAction", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof menu2ColWithLinks<Message>>[1]) =>
    h.div([h.Class("-m-8")], [menu2ColWithLinks({ ...model, description: model.description, heading: model.heading, onAction: Action({ id: "action" }) }, h)]),
} as const;
