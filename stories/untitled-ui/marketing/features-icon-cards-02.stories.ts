...
import { featuresIconCards02 } from "../../../../../packages/ui/src/marketing/features-icon-cards-02.ts";
...
const ItemPressed = m("FeaturesIconCards02ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresIconCards02<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresIconCards02({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-icon-cards-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Icon Cards 02",
};
