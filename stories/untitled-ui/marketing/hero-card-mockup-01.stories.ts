...
import { heroCardMockup01 } from "../../../../../packages/ui/src/marketing/hero-card-mockup-01.ts";
...
const Primary = m("HeroCardMockup01Primary");
const Secondary = m("HeroCardMockup01Secondary");
const Navigated = m("HeroCardMockup01Navigated", { href: S.String });
const MobileOpened = m("HeroCardMockup01MobileOpened");
const MobileClosed = m("HeroCardMockup01MobileClosed");
const AccountPressed = m("HeroCardMockup01AccountPressed");
const SearchChanged = m("HeroCardMockup01SearchChanged", { value: S.String });
type Message =
  | typeof Primary.Type
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "HeroCardMockup01MobileOpened") {
      return { ...model, isMobileOpen: true };
    }
    if (message._tag === "HeroCardMockup01MobileClosed") {
      return { ...model, isMobileOpen: false };
    }
    if (message._tag === "HeroCardMockup01SearchChanged") {
      return { ...model, searchValue: message.value };
    }
    return model;
  },
  view: (model: Model, h: Parameters<typeof heroCardMockup01<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        heroCardMockup01(
...
export default {
  ...componentMeta("hero-card-mockup-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Hero Card Mockup 01",
};
