...
import { contentSectionSimple01 } from "../../../../../packages/ui/src/marketing/content-section-simple-01.ts";
...
const specimen = (props: Args, h: Parameters<typeof contentSectionSimple01>[1]) =>
  h.div([h.Class("-m-8")], [contentSectionSimple01(props, h)]);

export default {
  ...componentMeta("content-section-simple-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Content/Content Section Simple 01",
};
...
export const Dark = {
  ...staticStory(Args, (props, h) =>
    h.div([h.Class("-m-8 min-h-screen bg-bg-primary"), h.DataAttribute("theme", "dark")], [contentSectionSimple01(props, h)]),
  ),
  args,
};
