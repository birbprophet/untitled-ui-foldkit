...
import { testimonialGlassmorphicCards03 } from "../../../../../packages/ui/src/marketing/testimonial-glassmorphic-cards-03.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialGlassmorphicCards03>[1]) =>
    h.div([h.Class("-m-8")], [testimonialGlassmorphicCards03({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-glassmorphic-cards-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Glassmorphic Cards 03",
};
