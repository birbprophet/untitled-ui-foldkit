...
import { footerLarge08Brand } from "../../../src/marketing/footer-large-08-brand.ts";
...
const HomePressed = m("FooterLarge08BrandHomePressed");
const LinkPressed = m("FooterLarge08BrandLinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge08BrandSocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge08BrandLinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge08BrandSocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge08Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge08Brand(
...
export default {
  ...componentMeta("footer-large-08-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 08 Brand",
};
