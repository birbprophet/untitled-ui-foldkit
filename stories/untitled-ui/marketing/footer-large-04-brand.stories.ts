...
const HomePressed = m("FooterLarge04BrandHomePressed");
const LinkPressed = m("FooterLarge04BrandLinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge04BrandSocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge04BrandLinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge04BrandSocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge04Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge04Brand(
...
export default {
  ...componentMeta("footer-large-04-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 04 Brand",
};
