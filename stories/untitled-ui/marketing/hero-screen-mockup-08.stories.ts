...
import { heroScreenMockup08 } from "../../../../../packages/ui/src/marketing/hero-screen-mockup-08.ts";
...
const Primary = m("HeroScreenMockup08Primary");
const Secondary = m("HeroScreenMockup08Secondary");
const Navigated = m("HeroScreenMockup08Navigated", { href: S.String });
const MobileOpened = m("HeroScreenMockup08MobileOpened");
const MobileClosed = m("HeroScreenMockup08MobileClosed");
const AccountPressed = m("HeroScreenMockup08AccountPressed");
const SearchChanged = m("HeroScreenMockup08SearchChanged", { value: S.String });
type Message =
  | typeof Primary.Type
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "HeroScreenMockup08MobileOpened") {
      return { ...model, isMobileOpen: true };
    }
    if (message._tag === "HeroScreenMockup08MobileClosed") {
      return { ...model, isMobileOpen: false };
    }
    if (message._tag === "HeroScreenMockup08SearchChanged") {
      return { ...model, searchValue: message.value };
    }
    return model;
  },
  view: (model: Model, h: Parameters<typeof heroScreenMockup08<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        heroScreenMockup08(
...
export default {
  ...componentMeta("hero-screen-mockup-08"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Hero Screen Mockup 08",
};
