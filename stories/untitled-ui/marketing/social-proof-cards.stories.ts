...
import { socialProofCards } from "../../../../../packages/ui/src/marketing/social-proof-cards.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof socialProofCards>[1]) =>
    h.div([h.Class("-m-8")], [socialProofCards({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("social-proof-cards"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Social Proof/Social Proof Cards",
};
