...
import { ctaAbstractImagesBrand } from "../../../../../packages/ui/src/marketing/cta-abstract-images-brand.ts";
...
const Primary = m("CtaAbstractImagesBrandPrimary");
const Secondary = m("CtaAbstractImagesBrandSecondary");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof ctaAbstractImagesBrand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
...
export default {
  ...componentMeta("cta-abstract-images-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Cta/Cta Abstract Images Brand",
};
