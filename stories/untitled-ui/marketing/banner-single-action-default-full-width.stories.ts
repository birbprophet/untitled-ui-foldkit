...
import { bannerSingleActionDefaultFullWidth } from "../../../../../packages/ui/src/marketing/banner-single-action-default-full-width.ts";
...
const Action = m("BannerSingleActionDefaultFullWidthAction");
const Dismissed = m("BannerSingleActionDefaultFullWidthDismissed");
...
const definition = {
  ...
  update: (model: Model, message: Message): Model =>
    message._tag === "BannerSingleActionDefaultFullWidthDismissed"
      ? { ...model, isVisible: false }
      : { ...model, actionHref: "#update-opened" },
  view: (model: Model, h: Parameters<typeof bannerSingleActionDefaultFullWidth<Message>>[1]) =>
    model.isVisible
...
export default {
  ...componentMeta("banner-single-action-default-full-width"),
  title: "Untitled UI/Marketing/Banners/Banner Single Action Default Full Width",
};
