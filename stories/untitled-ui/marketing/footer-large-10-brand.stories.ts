...
import { footerLarge10Brand } from "../../../src/marketing/footer-large-10-brand.ts";
...
const HomePressed = m("FooterLarge10BrandHomePressed");
const LinkPressed = m("FooterLarge10BrandLinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge10BrandSocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge10BrandHomePressed") {
      return { ...model, homeHref: "#home-opened" };
    }
    if (message._tag === "FooterLarge10BrandLinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge10BrandSocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge10Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge10Brand(
...
export default {
  ...componentMeta("footer-large-10-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 10 Brand",
};
