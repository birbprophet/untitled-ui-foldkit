...
import { menuBlogPostsWithSidebar } from "../../../../../packages/ui/src/marketing/menu-blog-posts-with-sidebar.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof menuBlogPostsWithSidebar>[1]) =>
    h.div([h.Class("-m-8")], [menuBlogPostsWithSidebar({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
