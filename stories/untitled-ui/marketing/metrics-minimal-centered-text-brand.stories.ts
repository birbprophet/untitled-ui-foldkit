...
import { metricsMinimalCenteredTextBrand } from "../../../../../packages/ui/src/marketing/metrics-minimal-centered-text-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof metricsMinimalCenteredTextBrand>[1]) =>
    h.div([h.Class("-m-8")], [metricsMinimalCenteredTextBrand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
