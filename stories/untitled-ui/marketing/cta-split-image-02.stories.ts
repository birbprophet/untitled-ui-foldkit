...
import { ctaSplitImage02 } from "../../../../../packages/ui/src/marketing/cta-split-image-02.ts";
...
const Primary = m("CtaSplitImage02Primary");
const Secondary = m("CtaSplitImage02Secondary");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof ctaSplitImage02<Message>>[1]) =>
    h.div([h.Class("-m-8")], [
      ctaSplitImage02({ ...model, onPrimary: Primary(), onSecondary: Secondary() }, h),
    ]),
} as const;
...
export default { ...componentMeta("cta-split-image-02"), parameters: { layout: "fullscreen" }, title: "Untitled UI/Marketing/Cta/Cta Split Image 02" };
