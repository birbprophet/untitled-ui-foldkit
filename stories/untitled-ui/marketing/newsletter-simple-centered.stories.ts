...
import { newsletterSimpleCentered } from "../../../../../packages/ui/src/marketing/newsletter-simple-centered.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof newsletterSimpleCentered>[1]) =>
    h.div([h.Class("-m-8")], [newsletterSimpleCentered({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("newsletter-simple-centered"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Newsletter Cta/Newsletter Simple Centered",
};
