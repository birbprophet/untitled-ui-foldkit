...
import { testimonialGlassmorphicCards02 } from "../../../../../packages/ui/src/marketing/testimonial-glassmorphic-cards-02.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialGlassmorphicCards02>[1]) =>
    h.div([h.Class("-m-8")], [testimonialGlassmorphicCards02({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-glassmorphic-cards-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Glassmorphic Cards 02",
};
