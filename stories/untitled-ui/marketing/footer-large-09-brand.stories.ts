...
import { footerLarge09Brand } from "../../../src/marketing/footer-large-09-brand.ts";
...
const HomePressed = m("FooterLarge09BrandHomePressed");
const LinkPressed = m("FooterLarge09BrandLinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge09BrandSocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge09BrandHomePressed") {
      return { ...model, homeHref: "#home-opened" };
    }
    if (message._tag === "FooterLarge09BrandLinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge09BrandSocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge09Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge09Brand(
...
export default {
  ...componentMeta("footer-large-09-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 09 Brand",
};
