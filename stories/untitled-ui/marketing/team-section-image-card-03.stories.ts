...
import { teamSectionImageCard03 } from "../../../../../packages/ui/src/marketing/team-section-image-card-03.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof teamSectionImageCard03>[1]) =>
    h.div([h.Class("-m-8")], [teamSectionImageCard03({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
