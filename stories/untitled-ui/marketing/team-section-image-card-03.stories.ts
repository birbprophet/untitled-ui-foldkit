...
const section = (args: SectionArgs, h: HtmlBuilder<{ readonly _tag: "Noop" }>) =>
  h.div([h.Class("-m-8")], [teamSectionImageCard03(args, h)]);
...
export default {
  ...componentMeta("team-section-image-card-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Team Sections/Team Section Image Card 03",
};
