...
import { featuresLargeScreenMockup02 } from "../../../../../packages/ui/src/marketing/features-large-screen-mockup-02.ts";
...
const ItemPressed = m("FeaturesLargeScreenMockup02ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresLargeScreenMockup02<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresLargeScreenMockup02({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-large-screen-mockup-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Large Screen Mockup 02",
};
