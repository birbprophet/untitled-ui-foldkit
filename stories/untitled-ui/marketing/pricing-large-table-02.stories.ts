...
import { pricingLargeTable02 } from "../../../../../packages/ui/src/marketing/pricing-large-table-02.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof pricingLargeTable02>[1]) =>
    h.div([h.Class("-m-8")], [pricingLargeTable02({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("pricing-large-table-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Pricing Sections/Pricing Large Table 02",
};
