...
const HomePressed = m("FooterLarge01HomePressed");
const LinkPressed = m("FooterLarge01LinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge01SocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge01LinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge01SocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge01<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge01(
...
export default {
  ...componentMeta("footer-large-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 01",
};
