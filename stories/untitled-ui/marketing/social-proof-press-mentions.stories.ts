...
import { socialProofPressMentions } from "../../../../../packages/ui/src/marketing/social-proof-press-mentions.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof socialProofPressMentions>[1]) =>
    h.div([h.Class("-m-8")], [socialProofPressMentions({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("social-proof-press-mentions"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Social Proof/Social Proof Press Mentions",
};
