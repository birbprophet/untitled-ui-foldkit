...
const section = (args: SectionArgs, h: HtmlBuilder<{ readonly _tag: "Noop" }>) =>
  h.div([h.Class("-m-8")], [socialProofPressMentions(args, h)]);
...
const args = {
  ctaLabel: "Learn more",
  description: "Read what leading publications are saying about Siglata.",
  eyebrow: "Press",
  heading: "Siglata in the news",
} as const;
...
export const Interactions = {
  ...
  play: async ({ canvasElement }: { readonly canvasElement: HTMLElement }) => {
    ...
    await expect(canvas.getByRole("heading")).toHaveTextContent("Siglata in the news");
  },
};
