...
import { featuresTabsMockup09 } from "../../../../../packages/ui/src/marketing/features-tabs-mockup-09.ts";
...
const TabSelected = m("FeaturesTabsMockup09TabSelected", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresTabsMockup09<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresTabsMockup09({ ...model, onSelect: (id) => TabSelected({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-tabs-mockup-09"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Tabs Mockup 09",
};
