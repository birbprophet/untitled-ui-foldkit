...
import { heroScreenMockup05 } from "../../../../../packages/ui/src/marketing/hero-screen-mockup-05.ts";
...
const Primary = m("HeroScreenMockup05Primary");
const Secondary = m("HeroScreenMockup05Secondary");
const Navigated = m("HeroScreenMockup05Navigated", { href: S.String });
const MobileOpened = m("HeroScreenMockup05MobileOpened");
const MobileClosed = m("HeroScreenMockup05MobileClosed");
const AccountPressed = m("HeroScreenMockup05AccountPressed");
const SearchChanged = m("HeroScreenMockup05SearchChanged", { value: S.String });
type Message =
  | typeof Primary.Type
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "HeroScreenMockup05MobileOpened") {
      return { ...model, isMobileOpen: true };
    }
    if (message._tag === "HeroScreenMockup05MobileClosed") {
      return { ...model, isMobileOpen: false };
    }
    if (message._tag === "HeroScreenMockup05SearchChanged") {
      return { ...model, searchValue: message.value };
    }
    return model;
  },
  view: (model: Model, h: Parameters<typeof heroScreenMockup05<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        heroScreenMockup05(
...
export default {
  ...componentMeta("hero-screen-mockup-05"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Hero Screen Mockup 05",
};
