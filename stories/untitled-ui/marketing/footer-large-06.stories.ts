...
import { footerLarge06 } from "../../../src/marketing/footer-large-06.ts";
...
const HomePressed = m("FooterLarge06HomePressed");
const LinkPressed = m("FooterLarge06LinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge06SocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge06LinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge06SocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge06<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge06(
...
export default {
  ...componentMeta("footer-large-06"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 06",
};
