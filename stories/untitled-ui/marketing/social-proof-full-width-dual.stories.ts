...
import { socialProofFullWidthDual } from "../../../../../packages/ui/src/marketing/social-proof-full-width-dual.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof socialProofFullWidthDual>[1]) =>
    h.div([h.Class("-m-8")], [socialProofFullWidthDual({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("social-proof-full-width-dual"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Social Proof/Social Proof Full Width Dual",
};
