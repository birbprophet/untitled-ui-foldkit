...
import { featuresSimpleIcons04Brand } from "../../../../../packages/ui/src/marketing/features-simple-icons-04-brand.ts";
...
const ItemPressed = m("FeaturesSimpleIcons04BrandItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresSimpleIcons04Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresSimpleIcons04Brand({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-simple-icons-04-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Simple Icons 04 Brand",
};
