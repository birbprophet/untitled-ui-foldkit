...
import { pricingSimpleAccentLine } from "../../../../../packages/ui/src/marketing/pricing-simple-accent-line.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof pricingSimpleAccentLine>[1]) =>
    h.div([h.Class("-m-8")], [pricingSimpleAccentLine({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("pricing-simple-accent-line"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Pricing Sections/Pricing Simple Accent Line",
};
