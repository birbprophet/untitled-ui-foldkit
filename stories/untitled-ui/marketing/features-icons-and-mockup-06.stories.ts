...
import { featuresIconsAndMockup06 } from "../../../../../packages/ui/src/marketing/features-icons-and-mockup-06.ts";
...
const ItemPressed = m("FeaturesIconsAndMockup06ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresIconsAndMockup06<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresIconsAndMockup06({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-icons-and-mockup-06"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Icons And Mockup 06",
};
