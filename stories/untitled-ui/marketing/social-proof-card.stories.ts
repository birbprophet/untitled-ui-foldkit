...
import { socialProofCard } from "../../../../../packages/ui/src/marketing/social-proof-card.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof socialProofCard>[1]) =>
    h.div([h.Class("-m-8")], [socialProofCard({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("social-proof-card"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Social Proof/Social Proof Card",
};
