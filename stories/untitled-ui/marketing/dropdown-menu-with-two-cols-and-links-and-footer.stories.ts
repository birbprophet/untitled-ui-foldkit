...
import { dropdownMenuWithTwoColsAndLinksAndFooter } from "../../../../../packages/ui/src/marketing/dropdown-menu-with-two-cols-and-links-and-footer.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof dropdownMenuWithTwoColsAndLinksAndFooter<Message>>[1]) =>
    h.div([h.Class("-m-8")], [dropdownMenuWithTwoColsAndLinksAndFooter({ ...model, description: model.description, heading: model.heading, onAction: Action({ id: "action" }) }, h)]),
} as const;
