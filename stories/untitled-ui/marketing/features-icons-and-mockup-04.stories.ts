...
import { featuresIconsAndMockup04 } from "../../../../../packages/ui/src/marketing/features-icons-and-mockup-04.ts";
...
const ItemPressed = m("FeaturesIconsAndMockup04ItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresIconsAndMockup04<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresIconsAndMockup04({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-icons-and-mockup-04"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Icons And Mockup 04",
};
