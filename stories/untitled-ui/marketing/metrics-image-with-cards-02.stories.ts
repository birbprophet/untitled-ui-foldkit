...
import { metricsImageWithCards02 } from "../../../../../packages/ui/src/marketing/metrics-image-with-cards-02.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof metricsImageWithCards02>[1]) =>
    h.div([h.Class("-m-8")], [metricsImageWithCards02({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("metrics-image-with-cards-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Metrics/Metrics Image With Cards 02",
};
