...
import { contentSectionSimple05 } from "../../../../../packages/ui/src/marketing/content-section-simple-05.ts";
...
const specimen = (props: Args, h: Parameters<typeof contentSectionSimple05>[1]) =>
  h.div([h.Class("-m-8")], [contentSectionSimple05(props, h)]);

export default {
  ...componentMeta("content-section-simple-05"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Content/Content Section Simple 05",
};
...
export const Dark = {
  ...staticStory(Args, (props, h) =>
    h.div([h.Class("-m-8 min-h-screen bg-bg-primary"), h.DataAttribute("theme", "dark")], [contentSectionSimple05(props, h)]),
  ),
  args,
};
