...
import { pricingSimpleBanner } from "../../../../../packages/ui/src/marketing/pricing-simple-banner.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof pricingSimpleBanner>[1]) =>
    h.div([h.Class("-m-8")], [pricingSimpleBanner({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("pricing-simple-banner"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Pricing Sections/Pricing Simple Banner",
};
