...
import { pricingSectionSimpleCards03 } from "../../../../../packages/ui/src/marketing/pricing-section-simple-cards-03.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof pricingSectionSimpleCards03>[1]) =>
    h.div([h.Class("-m-8")], [pricingSectionSimpleCards03({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("pricing-section-simple-cards-03"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Pricing Sections/Pricing Section Simple Cards 03",
};
