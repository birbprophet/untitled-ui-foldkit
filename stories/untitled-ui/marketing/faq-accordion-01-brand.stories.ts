...
const Cta = m("FaqAccordion01BrandCta");
const Toggle = m("FaqAccordion01BrandToggle", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FaqAccordion01BrandToggle") {
  ...
  view: (model: Model, h: Parameters<typeof faqAccordion01Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        faqAccordion01Brand(
...
const args = {
  ...
  items: [...faqAccordion01BrandDefaultItems],
} as const;

export default {
  ...componentMeta("faq-accordion-01-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Faq/Faq Accordion 01 Brand",
};
