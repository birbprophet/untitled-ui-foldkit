...
import { pricingDualAction } from "../../../../../packages/ui/src/marketing/pricing-dual-action.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof pricingDualAction>[1]) =>
    h.div([h.Class("-m-8")], [pricingDualAction({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("pricing-dual-action"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Pricing Sections/Pricing Dual Action",
};
