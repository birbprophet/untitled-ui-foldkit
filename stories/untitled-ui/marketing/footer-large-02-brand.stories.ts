...
const HomePressed = m("FooterLarge02BrandHomePressed");
const LinkPressed = m("FooterLarge02BrandLinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge02BrandSocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge02BrandLinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge02BrandSocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge02Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge02Brand(
...
export default {
  ...componentMeta("footer-large-02-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 02 Brand",
};
