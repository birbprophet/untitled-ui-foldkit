...
import { socialProofCardsBrand } from "../../../../../packages/ui/src/marketing/social-proof-cards-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof socialProofCardsBrand>[1]) =>
    h.div([h.Class("-m-8")], [socialProofCardsBrand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("social-proof-cards-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Social Proof/Social Proof Cards Brand",
};
