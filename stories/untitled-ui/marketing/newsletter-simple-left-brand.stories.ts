...
import { newsletterSimpleLeftBrand } from "../../../../../packages/ui/src/marketing/newsletter-simple-left-brand.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof newsletterSimpleLeftBrand>[1]) =>
    h.div([h.Class("-m-8")], [newsletterSimpleLeftBrand({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("newsletter-simple-left-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Newsletter Cta/Newsletter Simple Left Brand",
};
