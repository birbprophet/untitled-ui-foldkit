...
import { ctaScreenMockup02 } from "../../../../../packages/ui/src/marketing/cta-screen-mockup-02.ts";
...
const Primary = m("CtaScreenMockup02Primary");
const Secondary = m("CtaScreenMockup02Secondary");
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof ctaScreenMockup02<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        ctaScreenMockup02(
...
export default {
  ...componentMeta("cta-screen-mockup-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Cta/Cta Screen Mockup 02",
};
