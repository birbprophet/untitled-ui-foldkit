...
import { footerLarge11Brand } from "../../../src/marketing/footer-large-11-brand.ts";
...
const HomePressed = m("FooterLarge11BrandHomePressed");
const LinkPressed = m("FooterLarge11BrandLinkPressed", { id: S.String });
const SocialPressed = m("FooterLarge11BrandSocialPressed", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FooterLarge11BrandHomePressed") {
      return { ...model, homeHref: "#home-opened" };
    }
    if (message._tag === "FooterLarge11BrandLinkPressed") {
      return {
        ...model,
    ...
    if (message._tag === "FooterLarge11BrandSocialPressed") {
      return {
        ...model,
  ...
  view: (model: Model, h: Parameters<typeof footerLarge11Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        footerLarge11Brand(
...
export default {
  ...componentMeta("footer-large-11-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Footers/Footer Large 11 Brand",
};
