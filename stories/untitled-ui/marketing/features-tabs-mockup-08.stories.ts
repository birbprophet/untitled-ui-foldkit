...
import { featuresTabsMockup08 } from "../../../../../packages/ui/src/marketing/features-tabs-mockup-08.ts";
...
const TabSelected = m("FeaturesTabsMockup08TabSelected", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresTabsMockup08<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresTabsMockup08({ ...model, onSelect: (id) => TabSelected({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-tabs-mockup-08"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Tabs Mockup 08",
};
