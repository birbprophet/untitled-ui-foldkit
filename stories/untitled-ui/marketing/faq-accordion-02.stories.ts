...
import {
  faqAccordion02,
  faqAccordion02DefaultItems,
} from "../../../../../packages/ui/src/marketing/faq-accordion-02.ts";
...
const Cta = m("FaqAccordion02Cta");
const Toggle = m("FaqAccordion02Toggle", { id: S.String });
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "FaqAccordion02Toggle") {
  ...
  view: (model: Model, h: Parameters<typeof faqAccordion02<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        faqAccordion02(
...
const args = {
  ...
  items: [...faqAccordion02DefaultItems],
} as const;

export default {
  ...componentMeta("faq-accordion-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Faq/Faq Accordion 02",
};
