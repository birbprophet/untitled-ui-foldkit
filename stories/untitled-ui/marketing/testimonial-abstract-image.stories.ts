...
import { testimonialAbstractImage } from "../../../../../packages/ui/src/marketing/testimonial-abstract-image.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialAbstractImage>[1]) =>
    h.div([h.Class("-m-8")], [testimonialAbstractImage({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-abstract-image"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Abstract Image",
};
