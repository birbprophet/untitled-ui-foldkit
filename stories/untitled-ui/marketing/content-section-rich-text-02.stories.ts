...
import { contentSectionRichText02 } from "../../../../../packages/ui/src/marketing/content-section-rich-text-02.ts";
...
const specimen = (props: Args, h: Parameters<typeof contentSectionRichText02>[1]) =>
...
export const Dark = {
  ...staticStory(Args, (props, h) =>
    h.div([h.Class("-m-8 min-h-screen bg-bg-primary"), h.DataAttribute("theme", "dark")], [contentSectionRichText02(props, h)]),
  ),
  args,
};
