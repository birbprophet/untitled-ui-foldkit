...
import { featuresSimpleIcons02Brand } from "../../../../../packages/ui/src/marketing/features-simple-icons-02-brand.ts";
...
const ItemPressed = m("FeaturesSimpleIcons02BrandItemPressed", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresSimpleIcons02Brand<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresSimpleIcons02Brand({ ...model, onItem: (id) => ItemPressed({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-simple-icons-02-brand"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Simple Icons 02 Brand",
};
