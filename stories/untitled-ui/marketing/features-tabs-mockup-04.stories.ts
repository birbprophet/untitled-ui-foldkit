...
import { featuresTabsMockup04 } from "../../../../../packages/ui/src/marketing/features-tabs-mockup-04.ts";
...
const TabSelected = m("FeaturesTabsMockup04TabSelected", { id: S.String });
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof featuresTabsMockup04<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [featuresTabsMockup04({ ...model, onSelect: (id) => TabSelected({ id }) }, h)],
    ),
} as const;
...
export default {
  ...componentMeta("features-tabs-mockup-04"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Features/Features Tabs Mockup 04",
};
