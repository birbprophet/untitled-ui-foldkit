...
import { testimonialGlassmorphicCards01 } from "../../../../../packages/ui/src/marketing/testimonial-glassmorphic-cards-01.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialGlassmorphicCards01>[1]) =>
    h.div([h.Class("-m-8")], [testimonialGlassmorphicCards01({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-glassmorphic-cards-01"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Glassmorphic Cards 01",
};
