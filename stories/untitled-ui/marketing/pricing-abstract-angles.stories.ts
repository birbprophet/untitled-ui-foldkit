...
import { pricingAbstractAngles } from "../../../../../packages/ui/src/marketing/pricing-abstract-angles.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof pricingAbstractAngles>[1]) =>
    h.div([h.Class("-m-8")], [pricingAbstractAngles({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("pricing-abstract-angles"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Pricing Sections/Pricing Abstract Angles",
};
