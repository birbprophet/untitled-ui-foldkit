...
import { metricsCardGrayLight } from "../../../../../packages/ui/src/marketing/metrics-card-gray-light.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof metricsCardGrayLight>[1]) =>
    h.div([h.Class("-m-8")], [metricsCardGrayLight({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("metrics-card-gray-light"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Metrics/Metrics Card Gray Light",
};
