...
import { testimonialSocialCards02 } from "../../../../../packages/ui/src/marketing/testimonial-social-cards-02.ts";
...
const definition = {
  ...
  view: (model: Model, h: Parameters<typeof testimonialSocialCards02>[1]) =>
    h.div([h.Class("-m-8")], [testimonialSocialCards02({ ...model, description: model.description, heading: model.heading }, h)]),
} as const;
...
export default {
  ...componentMeta("testimonial-social-cards-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Testimonials/Testimonial Social Cards 02",
};
