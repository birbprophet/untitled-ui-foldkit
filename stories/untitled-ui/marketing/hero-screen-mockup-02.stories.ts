...
import { heroScreenMockup02 } from "../../../../../packages/ui/src/marketing/hero-screen-mockup-02.ts";
...
const Primary = m("HeroScreenMockup02Primary");
const Secondary = m("HeroScreenMockup02Secondary");
const Navigated = m("HeroScreenMockup02Navigated", { href: S.String });
const MobileOpened = m("HeroScreenMockup02MobileOpened");
const MobileClosed = m("HeroScreenMockup02MobileClosed");
const AccountPressed = m("HeroScreenMockup02AccountPressed");
const SearchChanged = m("HeroScreenMockup02SearchChanged", { value: S.String });
type Message =
  | typeof Primary.Type
...
const definition = {
  ...
  update: (model: Model, message: Message): Model => {
    if (message._tag === "HeroScreenMockup02MobileOpened") {
      return { ...model, isMobileOpen: true };
    }
    if (message._tag === "HeroScreenMockup02MobileClosed") {
      return { ...model, isMobileOpen: false };
    }
    if (message._tag === "HeroScreenMockup02SearchChanged") {
      return { ...model, searchValue: message.value };
    }
    return model;
  },
  view: (model: Model, h: Parameters<typeof heroScreenMockup02<Message>>[1]) =>
    h.div(
      [h.Class("-m-8")],
      [
        heroScreenMockup02(
...
export default {
  ...componentMeta("hero-screen-mockup-02"),
  parameters: { layout: "fullscreen" },
  title: "Untitled UI/Marketing/Header Section/Hero Screen Mockup 02",
};
