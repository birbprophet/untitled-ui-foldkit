...
import type { FeaturesTabsMockup09Props } from "../src/marketing/features-tabs-mockup-09.ts";

describe("features tabs mockup 09", () => {
  it("keeps tab selection controlled", () => {
    ...
    } satisfies FeaturesTabsMockup09Props<string>;

    expect(props.onSelect("collaborate")).toBe("select:collaborate");
    expect(featuresTabsMockup09).toBeTypeOf("function");
  });
});
