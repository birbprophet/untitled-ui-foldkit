...
import type { FeaturesTabsMockup08Props } from "../src/marketing/features-tabs-mockup-08.ts";

describe("features tabs mockup 08", () => {
  it("keeps tab selection controlled", () => {
    ...
    } satisfies FeaturesTabsMockup08Props<string>;

    expect(props.onSelect("collaborate")).toBe("select:collaborate");
    expect(featuresTabsMockup08).toBeTypeOf("function");
  });
});
