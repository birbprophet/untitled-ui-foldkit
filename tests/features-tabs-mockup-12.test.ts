...
import type { FeaturesTabsMockup12Props } from "../src/marketing/features-tabs-mockup-12.ts";

describe("features tabs mockup 12", () => {
  it("keeps tab selection controlled", () => {
    ...
    } satisfies FeaturesTabsMockup12Props<string>;

    expect(props.onSelect("collaborate")).toBe("select:collaborate");
    expect(featuresTabsMockup12).toBeTypeOf("function");
  });
});
