...
import type { FeaturesTabsMockup10Props } from "../src/marketing/features-tabs-mockup-10.ts";

describe("features tabs mockup 10", () => {
  it("keeps tab selection controlled", () => {
    ...
    } satisfies FeaturesTabsMockup10Props<string>;

    expect(props.onSelect("collaborate")).toBe("select:collaborate");
    expect(featuresTabsMockup10).toBeTypeOf("function");
  });
});
