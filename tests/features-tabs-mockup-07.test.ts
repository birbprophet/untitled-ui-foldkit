...
import type { FeaturesTabsMockup07Props } from "../src/marketing/features-tabs-mockup-07.ts";

describe("features tabs mockup 07", () => {
  it("keeps tab selection controlled", () => {
    ...
    } satisfies FeaturesTabsMockup07Props<string>;

    expect(props.onSelect("collaborate")).toBe("select:collaborate");
    expect(featuresTabsMockup07).toBeTypeOf("function");
  });
});
