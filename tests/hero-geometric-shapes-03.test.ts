...
import type { HeroGeometricShapes03Props } from "../src/marketing/hero-geometric-shapes-03.ts";

describe("hero geometric shapes 03", () => {
  it("keeps the authenticated section renderer controlled", () => {
    const props = {
      ...
      secondaryLabel: "Demo",
    } satisfies HeroGeometricShapes03Props<string>;
    expect(heroGeometricShapes03).toBeTypeOf("function");
