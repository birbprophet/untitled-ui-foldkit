...
import { featuresTabsMockup02 } from "../src/marketing/features-tabs-mockup-02.ts";
import type { FeaturesTabsMockup02Props } from "../src/marketing/features-tabs-mockup-02.ts";

describe("features tabs mockup 02", () => {
  it("keeps tab selection controlled", () => {
    ...
    } satisfies FeaturesTabsMockup02Props<string>;

    expect(props.onSelect("collaborate")).toBe("select:collaborate");
    expect(featuresTabsMockup02).toBeTypeOf("function");
  });
});
