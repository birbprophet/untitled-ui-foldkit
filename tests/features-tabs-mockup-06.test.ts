...
import type { FeaturesTabsMockup06Props } from "../src/marketing/features-tabs-mockup-06.ts";

describe("features tabs mockup 06", () => {
  it("keeps tab selection controlled", () => {
    ...
    } satisfies FeaturesTabsMockup06Props<string>;

    expect(props.onSelect("collaborate")).toBe("select:collaborate");
    expect(featuresTabsMockup06).toBeTypeOf("function");
  });
});
