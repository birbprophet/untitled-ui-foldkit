...
import type { FeaturesTabsMockup11Props } from "../src/marketing/features-tabs-mockup-11.ts";

describe("features tabs mockup 11", () => {
  it("keeps tab selection controlled", () => {
    ...
    } satisfies FeaturesTabsMockup11Props<string>;

    expect(props.onSelect("collaborate")).toBe("select:collaborate");
    expect(featuresTabsMockup11).toBeTypeOf("function");
  });
});
