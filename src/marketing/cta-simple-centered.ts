...
export const ctaSimpleCentered = <Message>(props: CtaSimpleCenteredProps<Message>, h: HtmlBuilder<Message>): Html =>
  h.section([h.Class("bg-bg-primary py-16 md:py-24"), h.Dir("ltr")], [
    h.div([h.Class("mx-auto max-w-container px-4 md:px-8")], [h.div([h.Class("flex flex-col justify-center text-center")], [
          ...
          h.div([h.Class("mt-8 flex flex-col-reverse gap-3 self-stretch md:mt-8 md:flex-row md:self-center")], [
