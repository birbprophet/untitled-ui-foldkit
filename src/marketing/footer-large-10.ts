...
export interface FooterLarge10NavItem {
...
export interface FooterLarge10NavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge10NavItem[];
  readonly label: string;
}

export interface FooterLarge10Social {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge10Props<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly navGroups: readonly FooterLarge10NavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge10Social[];
}
...
export const footerLarge10 = <Message>(
  props: FooterLarge10Props<Message>,
