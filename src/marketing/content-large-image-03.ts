...
export interface ContentLargeImage03Props<Message> {
...
export const contentLargeImage03Defaults = {
  ...
  heroAlt: "Mountains",
  heroSrc: "https://www.untitledui.com/marketing/mountains.webp",
} as const;

export const contentLargeImage03 = <Message>(
  props: ContentLargeImage03Props<Message>,
  ...
  h.div(
    ...
    [
      h.div(
        ...
        [
          h.div(
            [h.Class("mx-auto flex w-full max-w-5xl flex-col items-center")],
            [
              h.span(
          ...
          h.img([
            h.Alt(props.heroAlt),
            h.Class("mt-16 h-60 w-full object-cover md:h-160"),
            h.Src(props.heroSrc),
          ]),
        ],
      ),
