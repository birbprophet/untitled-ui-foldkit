...
export interface FeaturesIconsAndMockup04Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesIconsAndMockup04Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesIconsAndMockup04Item[];
...
const iconPaths: Record<FeaturesIconsAndMockup04Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesIconsAndMockup04Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesIconsAndMockup04Item,
...
const mockupImage = <Message>(
  props: FeaturesIconsAndMockup04Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.div(
...
export const featuresIconsAndMockup04 = <Message>(
  props: FeaturesIconsAndMockup04Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
