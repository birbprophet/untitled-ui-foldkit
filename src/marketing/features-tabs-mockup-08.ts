...
export interface FeaturesTabsMockup08Tab {
...
export interface FeaturesTabsMockup08Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly onSelect: (id: string) => NoInfer<Message>;
  readonly selectedId: string;
  readonly tabs: readonly FeaturesTabsMockup08Tab[];
}

export const featuresTabsMockup08 = <Message>(
  props: FeaturesTabsMockup08Props<Message>,
