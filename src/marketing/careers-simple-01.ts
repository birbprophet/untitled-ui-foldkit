...
export interface CareersSimple01Job {
...
export interface CareersSimple01Props<Message> {
  readonly description: string;
  readonly heading: string;
  readonly jobs: readonly CareersSimple01Job[];
...
export const careersSimple01 = <Message>(
  props: CareersSimple01Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
