...
export interface FooterLarge16Props<Message> {
...
export const footerLarge16 = <Message>(
  props: FooterLarge16Props<Message>,
      ...
      h.div(
        ...
        [
          ...
          h.div(
            ...
            [
              h.div([h.Class(`absolute top-0 left-0 h-px w-full bg-border-secondary`)]),
