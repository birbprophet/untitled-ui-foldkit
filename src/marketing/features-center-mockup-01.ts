...
export interface FeaturesCenterMockup01Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesCenterMockup01Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesCenterMockup01Item[];
...
const iconPaths: Record<FeaturesCenterMockup01Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesCenterMockup01Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesCenterMockup01Item,
...
const mockupImage = <Message>(
  props: FeaturesCenterMockup01Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.div(
...
export const featuresCenterMockup01 = <Message>(
  props: FeaturesCenterMockup01Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
