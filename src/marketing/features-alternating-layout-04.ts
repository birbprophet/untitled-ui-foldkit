...
export interface FeaturesAlternatingLayout04Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesAlternatingLayout04Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesAlternatingLayout04Item[];
...
const iconPaths: Record<FeaturesAlternatingLayout04Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesAlternatingLayout04Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesAlternatingLayout04Item,
...
export const featuresAlternatingLayout04 = <Message>(
  props: FeaturesAlternatingLayout04Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
