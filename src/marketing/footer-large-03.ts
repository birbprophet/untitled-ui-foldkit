...
export interface FooterLarge03NavItem {
...
export interface FooterLarge03NavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge03NavItem[];
  readonly label: string;
}

export interface FooterLarge03Social {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge03Props<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly navGroups: readonly FooterLarge03NavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge03Social[];
}
...
export const footerLarge03 = <Message>(
  props: FooterLarge03Props<Message>,
