...
export interface FeaturesIconsAndMockup06Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesIconsAndMockup06Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesIconsAndMockup06Item[];
...
const iconPaths: Record<FeaturesIconsAndMockup06Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesIconsAndMockup06Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesIconsAndMockup06Item,
...
const mockupImage = <Message>(
  props: FeaturesIconsAndMockup06Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.div(
...
export const featuresIconsAndMockup06 = <Message>(
  props: FeaturesIconsAndMockup06Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
