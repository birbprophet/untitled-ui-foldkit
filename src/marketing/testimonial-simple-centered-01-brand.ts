...
export interface TestimonialSimpleCentered01BrandProps {
...
export const testimonialSimpleCentered01Brand = <Message>(
  props: TestimonialSimpleCentered01BrandProps,
