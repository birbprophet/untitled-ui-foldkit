...
export type FaqSimple04BrandIcon = "credit-card" | "file" | "heart" | "mail" | "slash" | "switch";

export interface FaqSimple04BrandItem {
  readonly answer: string;
  readonly icon: FaqSimple04BrandIcon;
  readonly id: string;
  readonly question: string;
}

export interface FaqSimple04BrandAvatar {
  readonly alt: string;
...
export interface FaqSimple04BrandProps<Message> {
  readonly ctaDescription: string;
  readonly ctaHeading: string;
  readonly ctaLabel: string;
  readonly description: string;
  readonly heading: string;
  readonly items: readonly FaqSimple04BrandItem[];
  readonly onCta: NoInfer<Message>;
  readonly avatars: readonly FaqSimple04BrandAvatar[];
}

export const faqSimple04BrandDefaultItems = [
  {
...
] as const satisfies readonly FaqSimple04BrandItem[];

const iconPaths: Record<FaqSimple04BrandIcon, readonly string[]> = {
  "credit-card": [
...
const avatarNode = <Message>(entry: FaqSimple04BrandAvatar, h: HtmlBuilder<Message>): Html =>
  avatar({ alt: entry.alt, size: entry.size, src: entry.src }, h);

export const faqSimple04Brand = <Message>(
  props: FaqSimple04BrandProps<Message>,
  h: HtmlBuilder<Message>,
): Html => {
