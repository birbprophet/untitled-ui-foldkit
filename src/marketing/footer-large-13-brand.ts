...
export interface FooterLarge13BrandNavItem {
...
export interface FooterLarge13BrandNavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge13BrandNavItem[];
  readonly label: string;
}

export interface FooterLarge13BrandSocial {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge13BrandProps<Message> {
  ...
  readonly socials: readonly FooterLarge13BrandSocial[];
}
...
export const footerLarge13Brand = <Message>(
  props: FooterLarge13BrandProps<Message>,
