...
const iconPaths: Record<FaqSimple03BrandIcon, readonly string[]> = {
  "credit-card": [
...
const avatarNode = <Message>(entry: FaqSimple03BrandAvatar, h: HtmlBuilder<Message>): Html =>
