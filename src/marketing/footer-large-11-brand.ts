...
export interface FooterLarge11BrandNavItem {
...
export interface FooterLarge11BrandNavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge11BrandNavItem[];
  readonly label: string;
}

export interface FooterLarge11BrandSocial {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge11BrandProps<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly navGroups: readonly FooterLarge11BrandNavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge11BrandSocial[];
}
...
export const footerLarge11Brand = <Message>(
  props: FooterLarge11BrandProps<Message>,
