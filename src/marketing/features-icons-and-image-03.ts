...
export interface FeaturesIconsAndImage03Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesIconsAndImage03Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesIconsAndImage03Item[];
...
const iconPaths: Record<FeaturesIconsAndImage03Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesIconsAndImage03Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  item: FeaturesIconsAndImage03Item,
...
const mockupImage = <Message>(
  props: FeaturesIconsAndImage03Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.div(
...
export const featuresIconsAndImage03 = <Message>(
  props: FeaturesIconsAndImage03Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
