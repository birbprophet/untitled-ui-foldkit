...
export interface FooterLarge01BrandNavItem {
...
export interface FooterLarge01BrandNavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge01BrandNavItem[];
  readonly label: string;
}

export interface FooterLarge01BrandSocial {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge01BrandProps<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly logo: BrandLockup;
  readonly navGroups: readonly FooterLarge01BrandNavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge01BrandSocial[];
}
...
export const footerLarge01Brand = <Message>(
  props: FooterLarge01BrandProps<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.footer(
    [],
