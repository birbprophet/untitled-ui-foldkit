...
export interface FooterLarge04BrandNavItem {
...
export interface FooterLarge04BrandNavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge04BrandNavItem[];
  readonly label: string;
}

export interface FooterLarge04BrandSocial {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge04BrandProps<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly navGroups: readonly FooterLarge04BrandNavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge04BrandSocial[];
}
...
export const footerLarge04Brand = <Message>(
  props: FooterLarge04BrandProps<Message>,
