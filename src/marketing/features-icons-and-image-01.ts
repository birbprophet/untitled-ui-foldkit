...
export interface FeaturesIconsAndImage01Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesIconsAndImage01Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesIconsAndImage01Item[];
...
const iconPaths: Record<FeaturesIconsAndImage01Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesIconsAndImage01Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  item: FeaturesIconsAndImage01Item,
...
const mockupImage = <Message>(
  props: FeaturesIconsAndImage01Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.div(
...
export const featuresIconsAndImage01 = <Message>(
  props: FeaturesIconsAndImage01Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
