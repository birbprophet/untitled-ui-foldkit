...
export interface CtaSimpleLeftProps<Message> {
...
export const ctaSimpleLeft = <Message>(
  props: CtaSimpleLeftProps<Message>,
  ...
  h.section(
    ...
    [
      h.div(
        ...
        [
          h.div(
            [h.Class("flex flex-col justify-between lg:flex-row")],
            [
              h.div(
                [h.Class("max-w-3xl")],
                [
              ...
              h.div(
                [
                  h.Class(
                    "mt-8 flex flex-col-reverse gap-3 self-stretch sm:flex-row sm:self-start lg:mt-0",
                  ),
                ],
                [
                  button(
