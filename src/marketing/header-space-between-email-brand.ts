...
export interface HeaderSpaceBetweenEmailBrandProps<Message> {
...
export const headerSpaceBetweenEmailBrand = <Message>(
  props: HeaderSpaceBetweenEmailBrandProps<Message>,
