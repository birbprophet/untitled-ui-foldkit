...
export interface FooterLarge06NavItem {
...
export interface FooterLarge06NavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge06NavItem[];
  readonly label: string;
}

export interface FooterLarge06Social {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge06Props<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly logo: BrandLockup;
  readonly navGroups: readonly FooterLarge06NavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge06Social[];
}
...
export const footerLarge06 = <Message>(
  props: FooterLarge06Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.footer(
    [],
