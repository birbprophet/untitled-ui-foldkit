...
export interface FooterLarge02BrandNavItem {
...
export interface FooterLarge02BrandNavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge02BrandNavItem[];
  readonly label: string;
}

export interface FooterLarge02BrandSocial {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge02BrandProps<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly navGroups: readonly FooterLarge02BrandNavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge02BrandSocial[];
}
...
export const footerLarge02Brand = <Message>(
  props: FooterLarge02BrandProps<Message>,
