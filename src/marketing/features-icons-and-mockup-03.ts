...
export interface FeaturesIconsAndMockup03Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesIconsAndMockup03Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesIconsAndMockup03Item[];
...
const iconPaths: Record<FeaturesIconsAndMockup03Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesIconsAndMockup03Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesIconsAndMockup03Item,
...
const mockupImage = <Message>(
  props: FeaturesIconsAndMockup03Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.div(
...
export const featuresIconsAndMockup03 = <Message>(
  props: FeaturesIconsAndMockup03Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
