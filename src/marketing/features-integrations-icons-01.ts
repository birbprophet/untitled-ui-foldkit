...
export interface FeaturesIntegrationsIcons01Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesIntegrationsIcons01Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesIntegrationsIcons01Item[];
...
const iconPaths: Record<FeaturesIntegrationsIcons01Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesIntegrationsIcons01Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesIntegrationsIcons01Item,
...
export const featuresIntegrationsIcons01 = <Message>(
  props: FeaturesIntegrationsIcons01Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
