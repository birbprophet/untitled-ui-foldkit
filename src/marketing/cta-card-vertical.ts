...
export interface CtaCardVerticalProps<Message> {
...
export const ctaCardVertical = <Message>(
  props: CtaCardVerticalProps<Message>,
      ...
      h.div(
        ...
        [
          h.div(
            [
              h.Class(
                "flex flex-col gap-x-8 gap-y-8 rounded-2xl bg-bg-secondary px-6 py-10 lg:p-16 flex-col",
              ),
            ],
            [
              h.div(
