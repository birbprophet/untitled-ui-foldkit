...
export interface FooterSmall04Link {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterSmall04Props<Message> {
  readonly copyright: string;
  readonly homeHref: string;
  readonly links: readonly FooterSmall04Link[];
...
export const footerSmall04 = <Message>(
  props: FooterSmall04Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.footer(
...
export const footerSmall04DefaultLinks = [
  {
    href: "#",
    id: "overview",
    label: "Overview",
...
] as const satisfies readonly FooterSmall04Link[];
