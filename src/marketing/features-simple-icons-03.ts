...
export interface FeaturesSimpleIcons03Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesSimpleIcons03Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesSimpleIcons03Item[];
...
const iconPaths: Record<FeaturesSimpleIcons03Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesSimpleIcons03Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesSimpleIcons03Item,
...
export const featuresSimpleIcons03 = <Message>(
  props: FeaturesSimpleIcons03Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
