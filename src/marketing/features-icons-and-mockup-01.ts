...
export interface FeaturesIconsAndMockup01Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesIconsAndMockup01Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesIconsAndMockup01Item[];
...
const iconPaths: Record<FeaturesIconsAndMockup01Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesIconsAndMockup01Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesIconsAndMockup01Item,
...
const mockupImage = <Message>(
  props: FeaturesIconsAndMockup01Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.div(
...
export const featuresIconsAndMockup01 = <Message>(
  props: FeaturesIconsAndMockup01Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
