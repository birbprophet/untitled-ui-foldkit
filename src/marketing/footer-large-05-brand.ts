...
export interface FooterLarge05BrandNavItem {
...
export interface FooterLarge05BrandNavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge05BrandNavItem[];
  readonly label: string;
}

export interface FooterLarge05BrandSocial {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge05BrandProps<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly navGroups: readonly FooterLarge05BrandNavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge05BrandSocial[];
}
...
export const footerLarge05Brand = <Message>(
  props: FooterLarge05BrandProps<Message>,
