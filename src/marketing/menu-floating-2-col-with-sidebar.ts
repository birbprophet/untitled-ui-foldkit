...
export const menuFloating2ColWithSidebar = <Message>(
  props: MenuFloating2ColWithSidebarProps<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.div(
    [h.Class("md:rounded-2xl md:ring-1 md:ring-border-secondary_alt md:shadow-lg")],
