...
export interface FeaturesTabsMockup02Tab {
...
export interface FeaturesTabsMockup02Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly onSelect: (id: string) => NoInfer<Message>;
  readonly selectedId: string;
  readonly tabs: readonly FeaturesTabsMockup02Tab[];
}

export const featuresTabsMockup02 = <Message>(
  props: FeaturesTabsMockup02Props<Message>,
