...
export interface FeaturesSimpleIcons04BrandItem {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesSimpleIcons04BrandProps<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesSimpleIcons04BrandItem[];
...
const iconPaths: Record<FeaturesSimpleIcons04BrandItem["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesSimpleIcons04BrandItem["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesSimpleIcons04BrandItem,
...
export const featuresSimpleIcons04Brand = <Message>(
  props: FeaturesSimpleIcons04BrandProps<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
