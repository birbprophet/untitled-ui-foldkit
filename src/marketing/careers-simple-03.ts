...
export interface CareersSimple03Job {
...
export interface CareersSimple03Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly jobs: readonly CareersSimple03Job[];
...
export const careersSimple03 = <Message>(
  props: CareersSimple03Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
