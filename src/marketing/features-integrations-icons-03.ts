...
export interface FeaturesIntegrationsIcons03Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesIntegrationsIcons03Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesIntegrationsIcons03Item[];
...
const iconPaths: Record<FeaturesIntegrationsIcons03Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesIntegrationsIcons03Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesIntegrationsIcons03Item,
...
export const featuresIntegrationsIcons03 = <Message>(
  props: FeaturesIntegrationsIcons03Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
