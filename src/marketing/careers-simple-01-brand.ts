/* oxlint-disable effect/noReturnInArrow -- Direct FoldKit transcription of the authenticated Untitled UI brand section. */
import type { Html, HtmlBuilder } from "foldkit/html";

export type CareersSimple01BrandBadgeColor = "blue" | "indigo" | "orange" | "pink" | "success";

export interface CareersSimple01BrandJob {
  readonly badgeColor: CareersSimple01BrandBadgeColor;
...
export interface CareersSimple01BrandProps<Message> {
  readonly description: string;
  readonly heading: string;
  readonly jobs: readonly CareersSimple01BrandJob[];
...
export const careersSimple01Brand = <Message>(
  props: CareersSimple01BrandProps<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
