...
export interface FaqSimple02BrandItem {
  readonly answer: string;
  readonly icon: FaqSimple02BrandIcon;
  readonly id: string;
  readonly question: string;
}

export interface FaqSimple02BrandProps<Message> {
  readonly ctaDescription: string;
  readonly ctaHeading: string;
  readonly ctaLabel: string;
  readonly description: string;
  readonly heading: string;
  readonly items: readonly FaqSimple02BrandItem[];
...
export const faqSimple02BrandDefaultItems = [
  {
...
] as const satisfies readonly FaqSimple02BrandItem[];

const iconPaths: Record<FaqSimple02BrandIcon, readonly string[]> = {
  "credit-card": [
      ...
      h.div(
        ...
        [
          ...
          h.div(
            [
              h.Class(
                "mt-12 flex flex-col items-start justify-between gap-6 rounded-2xl bg-bg-brand-section_subtle px-5 py-8 md:mt-16 md:flex-row md:gap-8 md:p-8",
              ),
            ],
            [
              h.div(
