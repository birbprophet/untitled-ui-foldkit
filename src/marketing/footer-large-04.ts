...
export interface FooterLarge04NavItem {
...
export interface FooterLarge04NavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge04NavItem[];
  readonly label: string;
}

export interface FooterLarge04Social {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge04Props<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly logo: BrandLockup;
  readonly navGroups: readonly FooterLarge04NavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge04Social[];
}
...
export const footerLarge04 = <Message>(
  props: FooterLarge04Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.footer(
    [],
