...
export interface FeaturesSimpleIcons02Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesSimpleIcons02Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesSimpleIcons02Item[];
...
const iconPaths: Record<FeaturesSimpleIcons02Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesSimpleIcons02Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesSimpleIcons02Item,
...
export const featuresSimpleIcons02 = <Message>(
  props: FeaturesSimpleIcons02Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
