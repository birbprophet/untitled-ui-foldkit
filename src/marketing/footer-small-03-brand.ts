...
export interface FooterSmall03BrandLink {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterSmall03BrandProps<Message> {
...
export const footerSmall03Brand = <Message>(
  props: FooterSmall03BrandProps<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.footer(
...
export const footerSmall03BrandDefaultLinks = [
  {
    href: "#",
    id: "overview",
    label: "Overview",
...
] as const satisfies readonly FooterSmall03BrandLink[];
