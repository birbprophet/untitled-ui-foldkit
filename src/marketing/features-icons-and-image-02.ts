...
export interface FeaturesIconsAndImage02Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesIconsAndImage02Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesIconsAndImage02Item[];
...
const iconPaths: Record<FeaturesIconsAndImage02Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesIconsAndImage02Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  item: FeaturesIconsAndImage02Item,
...
const mockupImage = <Message>(
  props: FeaturesIconsAndImage02Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.div(
...
export const featuresIconsAndImage02 = <Message>(
  props: FeaturesIconsAndImage02Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
