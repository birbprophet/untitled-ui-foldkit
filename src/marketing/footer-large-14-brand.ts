...
export interface FooterLarge14BrandNavItem {
...
export interface FooterLarge14BrandNavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge14BrandNavItem[];
  readonly label: string;
}

export interface FooterLarge14BrandSocial {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge14BrandProps<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly logo: BrandLockup;
  readonly navGroups: readonly FooterLarge14BrandNavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge14BrandSocial[];
}
...
export const footerLarge14Brand = <Message>(
  props: FooterLarge14BrandProps<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.footer(
    [],
              ...
              h.div(
                ...
                [
                  ...
                  h.nav(
                    ...
                    [
                      h.ul(
                        [h.Class("grid flex-1 grid-cols-2 gap-8 md:grid-cols-3")],
