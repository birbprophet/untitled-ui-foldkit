...
export interface FeaturesIntegrationsIcons04Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesIntegrationsIcons04Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesIntegrationsIcons04Item[];
...
const iconPaths: Record<FeaturesIntegrationsIcons04Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesIntegrationsIcons04Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesIntegrationsIcons04Item,
...
export const featuresIntegrationsIcons04 = <Message>(
  props: FeaturesIntegrationsIcons04Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
