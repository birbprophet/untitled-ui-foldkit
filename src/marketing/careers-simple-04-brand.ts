...
export interface CareersSimple04BrandJob {
...
export interface CareersSimple04BrandProps<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly imageAlt: string;
  readonly jobs: readonly CareersSimple04BrandJob[];
  readonly onJob: (id: string) => NoInfer<Message>;
}

const imageUrl = new URL("careers-simple-04-brand-assets/smiling-girl-4.webp", import.meta.url)
  .href;
...
export const careersSimple04Brand = <Message>(
  props: CareersSimple04BrandProps<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
