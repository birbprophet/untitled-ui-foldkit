...
export interface CtaSplitImageQuote02Props<Message> {
...
export const ctaSplitImageQuote02 = <Message>(props: CtaSplitImageQuote02Props<Message>, h: HtmlBuilder<Message>): Html =>
