...
export interface FooterLarge05NavItem {
...
export interface FooterLarge05NavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge05NavItem[];
  readonly label: string;
}

export interface FooterLarge05Social {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge05Props<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly navGroups: readonly FooterLarge05NavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge05Social[];
}
...
export const footerLarge05 = <Message>(
  props: FooterLarge05Props<Message>,
