...
export interface FeaturesLargeScreenMockup01Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesLargeScreenMockup01Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesLargeScreenMockup01Item[];
...
const iconPaths: Record<FeaturesLargeScreenMockup01Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesLargeScreenMockup01Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesLargeScreenMockup01Item,
...
const mockupImage = <Message>(
  props: FeaturesLargeScreenMockup01Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.div(
...
export const featuresLargeScreenMockup01 = <Message>(
  props: FeaturesLargeScreenMockup01Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
