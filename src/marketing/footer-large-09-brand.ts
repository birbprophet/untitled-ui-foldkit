...
export interface FooterLarge09BrandNavItem {
...
export interface FooterLarge09BrandNavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge09BrandNavItem[];
  readonly label: string;
}

export interface FooterLarge09BrandSocial {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge09BrandProps<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly logo: BrandLockup;
  readonly navGroups: readonly FooterLarge09BrandNavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge09BrandSocial[];
}
...
export const footerLarge09Brand = <Message>(
  props: FooterLarge09BrandProps<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.footer(
    [],
