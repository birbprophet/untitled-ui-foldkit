...
export interface FeaturesAlternatingLayout01Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesAlternatingLayout01Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesAlternatingLayout01Item[];
...
const iconPaths: Record<FeaturesAlternatingLayout01Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesAlternatingLayout01Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesAlternatingLayout01Item,
...
export const featuresAlternatingLayout01 = <Message>(
  props: FeaturesAlternatingLayout01Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
