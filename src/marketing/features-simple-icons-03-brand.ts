...
export interface FeaturesSimpleIcons03BrandItem {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesSimpleIcons03BrandProps<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesSimpleIcons03BrandItem[];
...
const iconPaths: Record<FeaturesSimpleIcons03BrandItem["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesSimpleIcons03BrandItem["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesSimpleIcons03BrandItem,
...
export const featuresSimpleIcons03Brand = <Message>(
  props: FeaturesSimpleIcons03BrandProps<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
