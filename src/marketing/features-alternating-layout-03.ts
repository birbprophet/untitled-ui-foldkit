...
export interface FeaturesAlternatingLayout03Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesAlternatingLayout03Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesAlternatingLayout03Item[];
...
const iconPaths: Record<FeaturesAlternatingLayout03Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesAlternatingLayout03Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesAlternatingLayout03Item,
...
export const featuresAlternatingLayout03 = <Message>(
  props: FeaturesAlternatingLayout03Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
