...
export interface HeaderSpaceBetweenSearchBrandProps<Message> {
...
export const headerSpaceBetweenSearchBrand = <Message>(
  props: HeaderSpaceBetweenSearchBrandProps<Message>,
