...
export interface HeaderSpaceBetweenButtonsBrandProps<Message> {
...
export const headerSpaceBetweenButtonsBrand = <Message>(
  props: HeaderSpaceBetweenButtonsBrandProps<Message>,
