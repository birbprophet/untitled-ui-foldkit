...
export interface FooterLarge01NavItem {
...
export interface FooterLarge01NavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge01NavItem[];
  readonly label: string;
}

export interface FooterLarge01Social {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge01Props<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly logo: BrandLockup;
  readonly navGroups: readonly FooterLarge01NavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge01Social[];
}
...
export const footerLarge01 = <Message>(
  props: FooterLarge01Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.footer(
    [],
