...
export interface FooterSmall01Link {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterSmall01Props<Message> {
  readonly copyright: string;
  readonly homeHref: string;
  readonly links: readonly FooterSmall01Link[];
...
export const footerSmall01 = <Message>(
  props: FooterSmall01Props<Message>,
...
export const footerSmall01DefaultLinks = [
  {
    href: "#",
    id: "overview",
    label: "Overview",
...
] as const satisfies readonly FooterSmall01Link[];
