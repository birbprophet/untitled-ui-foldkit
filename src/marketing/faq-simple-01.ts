...
export type FaqSimple01Icon = "credit-card" | "file" | "heart" | "mail" | "slash" | "switch";

export interface FaqSimple01Item {
  readonly answer: string;
  readonly icon: FaqSimple01Icon;
  readonly id: string;
  readonly question: string;
}

export interface FaqSimple01Avatar {
  readonly alt: string;
...
export interface FaqSimple01Props<Message> {
  readonly ctaDescription: string;
  readonly ctaHeading: string;
  readonly ctaLabel: string;
  readonly description: string;
  readonly heading: string;
  readonly items: readonly FaqSimple01Item[];
  readonly onCta: NoInfer<Message>;
  readonly avatars: readonly FaqSimple01Avatar[];
}

export const faqSimple01DefaultItems = [
  {
...
] as const satisfies readonly FaqSimple01Item[];

const iconPaths: Record<FaqSimple01Icon, readonly string[]> = {
  "credit-card": [
...
const avatarNode = <Message>(entry: FaqSimple01Avatar, h: HtmlBuilder<Message>): Html =>
  avatar({ alt: entry.alt, size: entry.size, src: entry.src }, h);

export const faqSimple01 = <Message>(
  props: FaqSimple01Props<Message>,
  h: HtmlBuilder<Message>,
): Html => {
