...
export interface FeaturesIconsAndMockup08Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesIconsAndMockup08Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesIconsAndMockup08Item[];
...
const iconPaths: Record<FeaturesIconsAndMockup08Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesIconsAndMockup08Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesIconsAndMockup08Item,
...
const mockupImage = <Message>(
  props: FeaturesIconsAndMockup08Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.div(
...
export const featuresIconsAndMockup08 = <Message>(
  props: FeaturesIconsAndMockup08Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
