/* oxlint-disable effect/noReturnInArrow -- This is a direct FoldKit transcription of the authenticated Untitled UI full-width single-action banner. */
import type { Html, HtmlBuilder } from "foldkit/html";

export interface BannerSingleActionDefaultFullWidthProps<Message> {
...
export const bannerSingleActionDefaultFullWidth = <Message>(
  props: BannerSingleActionDefaultFullWidthProps<Message>,
