...
export interface FeaturesIconsAndMockup02Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesIconsAndMockup02Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesIconsAndMockup02Item[];
...
const iconPaths: Record<FeaturesIconsAndMockup02Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesIconsAndMockup02Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesIconsAndMockup02Item,
...
const mockupImage = <Message>(
  props: FeaturesIconsAndMockup02Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.div(
...
export const featuresIconsAndMockup02 = <Message>(
  props: FeaturesIconsAndMockup02Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
