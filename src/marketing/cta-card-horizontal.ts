...
export interface CtaCardHorizontalProps<Message> {
...
export const ctaCardHorizontal = <Message>(
  props: CtaCardHorizontalProps<Message>,
      ...
      h.div(
        ...
        [
          h.div(
            [
              h.Class(
                "flex flex-col gap-x-8 gap-y-8 rounded-2xl bg-bg-secondary px-6 py-10 lg:p-16 lg:flex-row",
              ),
            ],
            [
              h.div(
                ...
                [
                  ...
                  h.p(
                    [h.Class("mt-4 text-lg text-text-tertiary md:mt-5 lg:text-xl")],
                    [props.description],
                  ),
                ],
              ),
