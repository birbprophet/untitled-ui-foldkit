...
export interface FeaturesTabsMockup06Tab {
...
export interface FeaturesTabsMockup06Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly onSelect: (id: string) => NoInfer<Message>;
  readonly selectedId: string;
  readonly tabs: readonly FeaturesTabsMockup06Tab[];
}

export const featuresTabsMockup06 = <Message>(
  props: FeaturesTabsMockup06Props<Message>,
