...
export type ContactSimpleIcons01Icon = "email" | "office" | "phone";

export interface ContactSimpleIcons01Item {
  readonly cta: string;
  readonly href: string;
  readonly icon: ContactSimpleIcons01Icon;
  readonly id: string;
  readonly subtitle: string;
  readonly title: string;
}

export interface ContactSimpleIcons01Props<Message> {
  readonly items: readonly ContactSimpleIcons01Item[];
  readonly onContact: (id: string) => NoInfer<Message>;
}

const paths: Record<ContactSimpleIcons01Icon, readonly string[]> = {
  email: [
...
export const contactSimpleIcons01 = <Message>(
  props: ContactSimpleIcons01Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
