...
export interface FooterSmall04BrandLink {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterSmall04BrandProps<Message> {
  readonly copyright: string;
  readonly homeHref: string;
  readonly links: readonly FooterSmall04BrandLink[];
...
export const footerSmall04Brand = <Message>(
  props: FooterSmall04BrandProps<Message>,
...
export const footerSmall04BrandDefaultLinks = [
  {
    href: "#",
    id: "overview",
    label: "Overview",
...
] as const satisfies readonly FooterSmall04BrandLink[];
