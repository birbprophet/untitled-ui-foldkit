...
export interface FooterLarge10BrandNavItem {
...
export interface FooterLarge10BrandNavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge10BrandNavItem[];
  readonly label: string;
}

export interface FooterLarge10BrandSocial {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge10BrandProps<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly logo: BrandLockup;
  readonly navGroups: readonly FooterLarge10BrandNavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge10BrandSocial[];
}
...
export const footerLarge10Brand = <Message>(
  props: FooterLarge10BrandProps<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.footer(
    [],
