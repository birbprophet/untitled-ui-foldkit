...
export interface FeaturesSimpleIcons01BrandItem {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesSimpleIcons01BrandProps<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesSimpleIcons01BrandItem[];
...
const iconPaths: Record<FeaturesSimpleIcons01BrandItem["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesSimpleIcons01BrandItem["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesSimpleIcons01BrandItem,
...
export const featuresSimpleIcons01Brand = <Message>(
  props: FeaturesSimpleIcons01BrandProps<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
