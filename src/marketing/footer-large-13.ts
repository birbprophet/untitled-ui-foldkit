...
export interface FooterLarge13NavItem {
...
export interface FooterLarge13NavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge13NavItem[];
  readonly label: string;
}

export interface FooterLarge13Social {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge13Props<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly navGroups: readonly FooterLarge13NavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge13Social[];
}
...
export const footerLarge13 = <Message>(
  props: FooterLarge13Props<Message>,
