...
export interface FeaturesTabsMockup03Tab {
...
export interface FeaturesTabsMockup03Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly onSelect: (id: string) => NoInfer<Message>;
  readonly selectedId: string;
  readonly tabs: readonly FeaturesTabsMockup03Tab[];
}

export const featuresTabsMockup03 = <Message>(
  props: FeaturesTabsMockup03Props<Message>,
