...
export interface CareersSimple02BrandJob {
...
export interface CareersSimple02BrandProps<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly jobs: readonly CareersSimple02BrandJob[];
...
export const careersSimple02Brand = <Message>(
  props: CareersSimple02BrandProps<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
