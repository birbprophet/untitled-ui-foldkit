...
export interface FooterSmall02BrandLink {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterSmall02BrandProps<Message> {
  readonly copyright: string;
  readonly homeHref: string;
  readonly links: readonly FooterSmall02BrandLink[];
...
export const footerSmall02Brand = <Message>(
  props: FooterSmall02BrandProps<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.footer(
    [h.Class("bg-brand-section py-12")],
    [
      h.div(
        ...
        [
          h.div(
            ...
            [
              ...
              h.p(
                [h.Class("mt-12 text-sm text-quaternary_on-brand lg:mt-0 lg:w-40 lg:text-right")],
                [props.copyright],
              ),
            ],
          ),
...
export const footerSmall02BrandDefaultLinks = [
  {
    href: "#",
    id: "overview",
    label: "Overview",
...
] as const satisfies readonly FooterSmall02BrandLink[];
