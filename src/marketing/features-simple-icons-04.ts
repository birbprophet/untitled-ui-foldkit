...
export interface FeaturesSimpleIcons04Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesSimpleIcons04Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesSimpleIcons04Item[];
...
const iconPaths: Record<FeaturesSimpleIcons04Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesSimpleIcons04Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesSimpleIcons04Item,
...
export const featuresSimpleIcons04 = <Message>(
  props: FeaturesSimpleIcons04Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
