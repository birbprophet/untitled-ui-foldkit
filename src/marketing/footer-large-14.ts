...
export interface FooterLarge14NavItem {
...
export interface FooterLarge14NavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge14NavItem[];
  readonly label: string;
}

export interface FooterLarge14Social {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge14Props<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly navGroups: readonly FooterLarge14NavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge14Social[];
}
...
export const footerLarge14 = <Message>(
  props: FooterLarge14Props<Message>,
