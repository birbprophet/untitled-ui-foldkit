...
export interface FooterLarge03BrandNavItem {
...
export interface FooterLarge03BrandNavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge03BrandNavItem[];
  readonly label: string;
}

export interface FooterLarge03BrandSocial {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge03BrandProps<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly logo: BrandLockup;
  readonly navGroups: readonly FooterLarge03BrandNavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge03BrandSocial[];
}
...
export const footerLarge03Brand = <Message>(
  props: FooterLarge03BrandProps<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.footer(
    [],
