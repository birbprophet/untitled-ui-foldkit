...
export interface FeaturesTabsMockup04Tab {
...
export interface FeaturesTabsMockup04Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly onSelect: (id: string) => NoInfer<Message>;
  readonly selectedId: string;
  readonly tabs: readonly FeaturesTabsMockup04Tab[];
}

export const featuresTabsMockup04 = <Message>(
  props: FeaturesTabsMockup04Props<Message>,
