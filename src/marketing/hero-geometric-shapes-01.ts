...
export interface HeroGeometricShapes01Props<Message> {
...
export const heroGeometricShapes01 = <Message>(
  props: HeroGeometricShapes01Props<Message>,
  ...
  h.div(
    ...
    [
      h.img([
        ...
        h.Loading("lazy"),
        h.Src("https://www.untitledui.com/patterns/light/grid-md-desktop.svg"),
      ]),
      h.img([
        h.Alt("Grid of dots"),
        h.AriaHidden(true),
        ...
        h.Loading("lazy"),
        h.Src("https://www.untitledui.com/patterns/light/grid-md-mobile.svg"),
      ]),
      props.navigation,
      h.section(
