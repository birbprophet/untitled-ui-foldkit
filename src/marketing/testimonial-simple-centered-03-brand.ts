...
export interface TestimonialSimpleCentered03BrandProps {
...
export const testimonialSimpleCentered03Brand = <Message>(
  props: TestimonialSimpleCentered03BrandProps,
