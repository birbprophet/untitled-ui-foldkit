...
export interface FooterLarge09NavItem {
...
export interface FooterLarge09NavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge09NavItem[];
  readonly label: string;
}

export interface FooterLarge09Social {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge09Props<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly navGroups: readonly FooterLarge09NavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge09Social[];
}
...
export const footerLarge09 = <Message>(
  props: FooterLarge09Props<Message>,
