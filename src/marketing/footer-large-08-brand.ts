...
export interface FooterLarge08BrandNavItem {
...
export interface FooterLarge08BrandNavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge08BrandNavItem[];
  readonly label: string;
}

export interface FooterLarge08BrandSocial {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge08BrandProps<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly navGroups: readonly FooterLarge08BrandNavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge08BrandSocial[];
}
...
export const footerLarge08Brand = <Message>(
  props: FooterLarge08BrandProps<Message>,
