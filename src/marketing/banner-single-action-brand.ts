/* oxlint-disable effect/noReturnInArrow -- This is a direct FoldKit transcription of the authenticated Untitled UI brand single-action banner. */
import type { Html, HtmlBuilder } from "foldkit/html";

export interface BannerSingleActionBrandProps<Message> {
...
export const bannerSingleActionBrand = <Message>(
  props: BannerSingleActionBrandProps<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.div(
    [
      h.Class(
        "relative mx-0 mb-4 flex flex-col gap-3 rounded-xl border-t border-brand_alt bg-brand-section_subtle p-4 shadow-lg in-data-[theme=dark]:border-neutral-700 md:m-0 md:flex-row md:items-center md:border-t-0 md:border-b md:border-brand md:p-4 md:in-data-[theme=dark]:border-neutral-700",
      ),
      h.Dir("ltr"),
    ],
    [
