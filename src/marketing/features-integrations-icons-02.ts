...
export interface FeaturesIntegrationsIcons02Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesIntegrationsIcons02Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesIntegrationsIcons02Item[];
...
const iconPaths: Record<FeaturesIntegrationsIcons02Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesIntegrationsIcons02Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesIntegrationsIcons02Item,
...
export const featuresIntegrationsIcons02 = <Message>(
  props: FeaturesIntegrationsIcons02Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
