...
export interface FeaturesAlternatingLayout02Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesAlternatingLayout02Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesAlternatingLayout02Item[];
...
const iconPaths: Record<FeaturesAlternatingLayout02Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesAlternatingLayout02Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesAlternatingLayout02Item,
...
export const featuresAlternatingLayout02 = <Message>(
  props: FeaturesAlternatingLayout02Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
