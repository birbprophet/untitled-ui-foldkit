...
export interface FeaturesTabsMockup11Tab {
...
export interface FeaturesTabsMockup11Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly onSelect: (id: string) => NoInfer<Message>;
  readonly selectedId: string;
  readonly tabs: readonly FeaturesTabsMockup11Tab[];
}

export const featuresTabsMockup11 = <Message>(
  props: FeaturesTabsMockup11Props<Message>,
