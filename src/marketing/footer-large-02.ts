...
export interface FooterLarge02NavItem {
...
export interface FooterLarge02NavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge02NavItem[];
  readonly label: string;
}

export interface FooterLarge02Social {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge02Props<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly navGroups: readonly FooterLarge02NavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge02Social[];
}
...
export const footerLarge02 = <Message>(
  props: FooterLarge02Props<Message>,
