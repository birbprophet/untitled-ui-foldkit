...
export interface FeaturesTabsMockup05Tab {
...
export interface FeaturesTabsMockup05Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly onSelect: (id: string) => NoInfer<Message>;
  readonly selectedId: string;
  readonly tabs: readonly FeaturesTabsMockup05Tab[];
}

export const featuresTabsMockup05 = <Message>(
  props: FeaturesTabsMockup05Props<Message>,
