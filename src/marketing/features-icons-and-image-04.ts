...
export interface FeaturesIconsAndImage04Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesIconsAndImage04Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesIconsAndImage04Item[];
...
const iconPaths: Record<FeaturesIconsAndImage04Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesIconsAndImage04Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  item: FeaturesIconsAndImage04Item,
...
const mockupImage = <Message>(
  props: FeaturesIconsAndImage04Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.div(
...
export const featuresIconsAndImage04 = <Message>(
  props: FeaturesIconsAndImage04Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
