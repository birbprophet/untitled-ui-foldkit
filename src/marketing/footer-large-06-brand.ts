...
export interface FooterLarge06BrandNavItem {
...
export interface FooterLarge06BrandNavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge06BrandNavItem[];
  readonly label: string;
}

export interface FooterLarge06BrandSocial {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge06BrandProps<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly navGroups: readonly FooterLarge06BrandNavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge06BrandSocial[];
}
...
export const footerLarge06Brand = <Message>(
  props: FooterLarge06BrandProps<Message>,
