...
export interface FeaturesTabsMockup09Tab {
...
export interface FeaturesTabsMockup09Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly onSelect: (id: string) => NoInfer<Message>;
  readonly selectedId: string;
  readonly tabs: readonly FeaturesTabsMockup09Tab[];
}

export const featuresTabsMockup09 = <Message>(
  props: FeaturesTabsMockup09Props<Message>,
