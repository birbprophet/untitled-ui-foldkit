...
export const menu3ColWithSidebar = <Message>(props: Menu3ColWithSidebarProps<Message>, h: HtmlBuilder<Message>): Html =>
  h.section([h.Class("relative overflow-hidden bg-bg-primary md:shadow-lg"), h.Dir("ltr")], [
    h.div([h.Class("mx-auto flex max-w-container flex-col md:items-start md:px-8 md:pb-6 xl:flex-row xl:pb-0")], [
      h.div([h.Class("grid grid-cols-1 gap-5 pt-4 pb-5 md:flex-1 md:grid-cols-3 md:py-6 md:pr-5")], [
