...
export interface FooterLarge12BrandNavItem {
...
export interface FooterLarge12BrandNavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge12BrandNavItem[];
  readonly label: string;
}

export interface FooterLarge12BrandSocial {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge12BrandProps<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly logo: BrandLockup;
  readonly navGroups: readonly FooterLarge12BrandNavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge12BrandSocial[];
}
...
export const footerLarge12Brand = <Message>(
  props: FooterLarge12BrandProps<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.footer(
    [],
