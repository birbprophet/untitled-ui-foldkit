...
export interface FeaturesIconCards02Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesIconCards02Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesIconCards02Item[];
...
const iconPaths: Record<FeaturesIconCards02Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesIconCards02Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesIconCards02Item,
...
export const featuresIconCards02 = <Message>(
  props: FeaturesIconCards02Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
