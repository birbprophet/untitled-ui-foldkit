...
export interface FeaturesIconsAndMockup07Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesIconsAndMockup07Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesIconsAndMockup07Item[];
...
const iconPaths: Record<FeaturesIconsAndMockup07Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesIconsAndMockup07Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesIconsAndMockup07Item,
...
const mockupImage = <Message>(
  props: FeaturesIconsAndMockup07Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.div(
...
export const featuresIconsAndMockup07 = <Message>(
  props: FeaturesIconsAndMockup07Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
