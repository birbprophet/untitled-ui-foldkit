...
export interface TestimonialSimpleCentered02BrandProps {
...
export const testimonialSimpleCentered02Brand = <Message>(
  props: TestimonialSimpleCentered02BrandProps,
