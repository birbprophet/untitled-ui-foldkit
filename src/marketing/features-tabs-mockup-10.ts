...
export interface FeaturesTabsMockup10Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly onSelect: (id: string) => NoInfer<Message>;
  readonly selectedId: string;
  readonly tabs: readonly FeaturesTabsMockup10Tab[];
}

export const featuresTabsMockup10 = <Message>(
  props: FeaturesTabsMockup10Props<Message>,
