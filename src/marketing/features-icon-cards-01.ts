...
export interface FeaturesIconCards01Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesIconCards01Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesIconCards01Item[];
...
const iconPaths: Record<FeaturesIconCards01Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesIconCards01Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesIconCards01Item,
...
export const featuresIconCards01 = <Message>(
  props: FeaturesIconCards01Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
