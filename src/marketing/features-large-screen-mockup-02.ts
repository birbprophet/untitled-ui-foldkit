...
export interface FeaturesLargeScreenMockup02Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesLargeScreenMockup02Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesLargeScreenMockup02Item[];
...
const iconPaths: Record<FeaturesLargeScreenMockup02Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesLargeScreenMockup02Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesLargeScreenMockup02Item,
...
const mockupImage = <Message>(
  props: FeaturesLargeScreenMockup02Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.div(
...
export const featuresLargeScreenMockup02 = <Message>(
  props: FeaturesLargeScreenMockup02Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
