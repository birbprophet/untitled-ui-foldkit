...
export interface FooterLarge11NavItem {
...
export interface FooterLarge11NavGroup {
  readonly id: string;
  readonly items: readonly FooterLarge11NavItem[];
  readonly label: string;
}

export interface FooterLarge11Social {
  readonly href: string;
  readonly id: string;
  readonly label: string;
}

export interface FooterLarge11Props<Message> {
  readonly copyright: string;
  readonly description: string;
  readonly homeHref: string;
  readonly navGroups: readonly FooterLarge11NavGroup[];
  readonly onHome: NoInfer<Message>;
  readonly onLink: (id: string) => NoInfer<Message>;
  readonly onSocial: (id: string) => NoInfer<Message>;
  readonly socials: readonly FooterLarge11Social[];
}
...
export const footerLarge11 = <Message>(
  props: FooterLarge11Props<Message>,
