...
export interface FeaturesTabsMockup12Tab {
...
export interface FeaturesTabsMockup12Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly onSelect: (id: string) => NoInfer<Message>;
  readonly selectedId: string;
  readonly tabs: readonly FeaturesTabsMockup12Tab[];
}

export const featuresTabsMockup12 = <Message>(
  props: FeaturesTabsMockup12Props<Message>,
