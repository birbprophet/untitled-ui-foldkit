...
export interface FeaturesSimpleIcons01Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesSimpleIcons01Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesSimpleIcons01Item[];
...
const iconPaths: Record<FeaturesSimpleIcons01Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesSimpleIcons01Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesSimpleIcons01Item,
...
export const featuresSimpleIcons01 = <Message>(
  props: FeaturesSimpleIcons01Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
