...
export interface FeaturesIconsAndMockup05Item {
  readonly icon:
    | "chat"
    | "zap"
    | "chart"
...
export interface FeaturesIconsAndMockup05Props<Message> {
  readonly description: string;
  readonly eyebrow: string;
  readonly heading: string;
  readonly items: readonly FeaturesIconsAndMockup05Item[];
...
const iconPaths: Record<FeaturesIconsAndMockup05Item["icon"], readonly string[]> = {
  chart: [
...
const featuredIcon = <Message>(
  kind: FeaturesIconsAndMockup05Item["icon"],
  size: "md" | "lg",
  theme: "light" | "dark",
...
const featureItem = <Message>(
  feature: FeaturesIconsAndMockup05Item,
...
const mockupImage = <Message>(
  props: FeaturesIconsAndMockup05Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.div(
...
export const featuresIconsAndMockup05 = <Message>(
  props: FeaturesIconsAndMockup05Props<Message>,
  h: HtmlBuilder<Message>,
): Html =>
  h.section(
