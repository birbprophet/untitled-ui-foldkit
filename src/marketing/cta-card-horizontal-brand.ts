...
export interface CtaCardHorizontalBrandProps<Message> {
...
export const ctaCardHorizontalBrand = <Message>(
  props: CtaCardHorizontalBrandProps<Message>,
      ...
      h.div(
        ...
        [
          h.div(
            [
              h.Class(
                "flex flex-col gap-x-8 gap-y-8 rounded-2xl bg-brand-section px-6 py-10 lg:p-16 lg:flex-row",
              ),
            ],
            [
              h.div(
